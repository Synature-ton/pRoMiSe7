<%@ page language="VB" autoeventwireup="false" inherits="ReportPrepaid_PrepaidReportSummary, App_Web_prepaidreportsummary.aspx.71748ee8" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Prepaid Summary Report</title>
        ...
        <table bgcolor="White" cellpadding="0" cellspacing="0">
            <tr style="background-color: #EEEEEE">
                ...
                <td colspan="2" style="background-image: url('../images/headerbg2000.jpg');">
                    <div class="noprint">
                        <asp:Label ID="lblHeader" runat="server" Text="Prepaid Summary Report" CssClass="headerText"></asp:Label>
                    </div>
                </td>
