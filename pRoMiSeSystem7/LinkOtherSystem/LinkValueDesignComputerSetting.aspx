<%@ page language="VB" autoeventwireup="false" inherits="LinkOtherSystem_ListValueDesignComputerSetting, App_Web_linkvaluedesigncomputersetting.aspx.5253a923" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>ValueDesignComputerSetting</title>
    ...
    <td>
        <table width="100%">
            <tr><td align="left" width="70%"><b class="headerText"><asp:DropDownList ID="cboShopName" AutoPostBack="true" runat="server"></asp:DropDownList>
                ...
                <td align="right">[<a href="LinkValueDesignSetting.aspx" ><asp:Label ID="lblGoBack" runat="server" Text="Back" /></a>]</td>
            </tr>
        </table>
    </td>
    <td>&nbsp;</td>
...
<thead>
	<tr>
		...
		<th id="thTerminalID" align="center" width="35%" runat="server" ><asp:Label ID="lblValueDesignTerminalID" Text="ValueDesign TerminalID" runat="server" /></th>
	</tr>
</thead>
<tbody>
