...
<html>
<head>
<title>Sale Reports By Zone</title>
...
Dim PageID As Integer  = 998
    ...
    Sub Page_Load()
        ...
        If User.Identity.IsAuthenticated And Session("Sale_Report_ByZone") Then
            ...
            Try
                ...
                LangText0.Text = "Sale Report By Zone"
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If FoundError = False Then
            ...
            Dim TableNameString As String = "DummyReportByZone_" + Session.SessionID
            Dim ZoneTable, GroupTable As DataTable
            'Application.Lock()
            Dim dtTable As DataTable = getReport.SaleReportByZone(outputString, ZoneTable, GroupTable, TableNameString, StartDate, EndDate, Request.Form("ShopID"), objCnn)

            getReport.GenOutputSaleByZone(outputString, TableHeaderString, TableNameString, ZoneTable, GroupTable, GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, Session("LangID"), objCnn)
            ...
            End If
            ResultSearchText.InnerHtml = "Sale Report By Zone of " + ShopDisplay + " (" + ReportDate + ")"
            'Application.UnLock()
