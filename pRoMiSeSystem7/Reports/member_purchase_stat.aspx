...
<table>
	<tr>
		...
		<td><asp:RadioButton ID="Radio_2" GroupName="Group1" AutoPostBack="true" OnCheckedChanged="DisplayData" CssClass="text" runat="server" /></td>
	</tr>
</table>
...
Public Function BuildDataByDate() As String
	...
	Dim dtTable As DataTable = getReport.MemberPurchaseReports(1,Request.QueryString("StartDate"),Request.QueryString("EndDate"),Request.QueryString("ShopList"),Request.QueryString("MemberID"), Session("LangID"), NetSale, objCnn)
...
Public Function BuildDataByProduct() As String
	...
	Dim dtTable As DataTable = getReport.MemberPurchaseReports(0,Request.QueryString("StartDate"),Request.QueryString("EndDate"),Request.QueryString("ShopList"),Request.QueryString("MemberID"), Session("LangID"), NetSale, objCnn)
