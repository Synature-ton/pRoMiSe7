...
<html>
<head>
<title>Sale and Cost By Dept Reports</title>
...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="Revenue Summary Report" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("RevenueReport") Then
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Dim ExpenseData,ExpenseCategory As DataTable

		ResultText.InnerHtml = RevenueSummaryReport(dtTable,ExpenseCategory,ExpenseData, StartDate, EndDate, Request.Form("ShopIDList"),SelMonth, SelYear, objCnn)
		
		Dim HeaderString As String = ""
		
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """></td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Outlet Code</td>"		
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Outlet Name</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Total Sale<br>(Before VAT)</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Material Cost</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>%</td>"
		For i = 0 To ExpenseCategory.Rows.Count - 1
			HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + ExpenseData.Rows(i)("ExpenseCategoryName") + "</td>"
			HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>%</td>"
		Next
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Total Expense</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>%</td>"
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Profit</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>% Profit</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Profit/Sqm</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Profit/Investment</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Profit/Table</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Profit/Chair</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Profit/Worker</td>"
		...
		For i = 0 To dtTable.Rows.Count - 1
			...
			outputString = outputString.Append("<td align=""center"" class=""" + TextClass + """>" & dtTable.Rows(i)("ProductLevelCode") & "</td>")
			outputString = outputString.Append("<td align=""center"" class=""" + TextClass + """>" & dtTable.Rows(i)("ProductLevelName") & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(dtTable.Rows(i)("SaleAmount")).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(dtTable.Rows(i)("MaterialCost")).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(dtTable.Rows(i)("MaterialCost")/dtTable.Rows(i)("SaleAmount")).ToString(FormatObject.PercentFormat, ci) + "</td>")
			SumCost = dtTable.Rows(i)("MaterialCost")
			TotalExpense = 0
			For j = 0 To ExpenseCategory.Rows.Count - 1
				expression = "ExpenseCategoryID = " + ExpenseCategory.Rows(j)("ExpenseCategoryID").ToString + " AND ShopID=" + dtTable.Rows(i)("ShopID").ToString + " AND ExpenseMonth=" + SelMonth.ToString + " AND ExpenseYear=" + SelYear.ToString
				'TestString += "<P>" + expression
                foundRows = ExpenseData.Select(expression)
				If foundRows.GetUpperBound(0) >= 0 Then
					ExpenseValue = foundRows(0)("ExpenseAmount")
				Else
					ExpenseValue = 0
				End If
				SumCost += ExpenseValue
				TotalExpense += ExpenseValue
				outputString = outputString.Append("<td bgColor=""#ccffff"" align=""right"" class=""" + TextClass + """>" + CDbl(ExpenseValue).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
				outputString = outputString.Append("<td bgColor=""#ccffff"" align=""right"" class=""" + TextClass + """>" + CDbl(ExpenseValue/dtTable.Rows(i)("SaleAmount")).ToString(FormatObject.PercentFormat, ci) + "</td>")
			Next
			
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(TotalExpense).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(TotalExpense/dtTable.Rows(i)("SaleAmount")).ToString(FormatObject.PercentFormat, ci) + "</td>")
			
			outputString = outputString.Append("<td bgColor=""#ffff99"" align=""right"" class=""" + TextClass + """>" + CDbl(SumCost).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td bgColor=""#ffff99"" align=""right"" class=""" + TextClass + """>" + CDbl(SumCost/dtTable.Rows(i)("SaleAmount")).ToString(FormatObject.PercentFormat, ci) + "</td>")
			
			Profit = dtTable.Rows(i)("SaleAmount") - SumCost
			outputString = outputString.Append("<td bgColor=""#ffdab9"" align=""right"" class=""" + TextClass + """>" + CDbl(Profit).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td bgColor=""#ffdab9"" align=""right"" class=""" + TextClass + """>" + CDbl(Profit/dtTable.Rows(i)("SaleAmount")).ToString(FormatObject.PercentFormat, ci) + "</td>")
			
			If Not IsDBNull(dtTable.Rows(i)("StoreSizeData")) AND dtTable.Rows(i)("StoreSizeData") <> 0 Then
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(Profit/dtTable.Rows(i)("StoreSizeData")).ToString(FormatObject.NumericFormat, ci) + "</td>")
			Else
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + "-" + "</td>")
			End If
			
			If Not IsDBNull(dtTable.Rows(i)("TotalInvestmentData")) AND dtTable.Rows(i)("TotalInvestmentData") <> 0 Then
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(Profit/dtTable.Rows(i)("TotalInvestmentData")).ToString(FormatObject.NumericFormat, ci) + "</td>")
			Else
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + "-" + "</td>")
			End If
			
			If Not IsDBNull(dtTable.Rows(i)("TotalTableData")) AND dtTable.Rows(i)("TotalTableData") <> 0 Then
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(Profit/dtTable.Rows(i)("TotalTableData")).ToString(FormatObject.NumericFormat, ci) + "</td>")
			Else
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + "-" + "</td>")
			End If
			
			If Not IsDBNull(dtTable.Rows(i)("TotalChairData")) AND dtTable.Rows(i)("TotalChairData") <> 0 Then
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(Profit/dtTable.Rows(i)("TotalChairData")).ToString(FormatObject.NumericFormat, ci) + "</td>")
			Else
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + "-" + "</td>")
			End If	
			
			If Not IsDBNull(dtTable.Rows(i)("TotalWorkerData")) AND dtTable.Rows(i)("TotalWorkerData") <> 0 Then
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(Profit/dtTable.Rows(i)("TotalWorkerData")).ToString(FormatObject.NumericFormat, ci) + "</td>")
			Else
				outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + "-" + "</td>")
			End If
			outputString = outputString.Append("</tr>")
		...
		ResultSearchText.InnerHtml = "Revenue Summary Report of " + ShopDisplay + " (" + ReportDate + ")"
...
Public Function RevenueSummaryReport(ByRef dtTable As DataTable, ByRef ExpenseCategory As DataTable, ByRef ExpenseData As DataTable, ByVal StartDate As String, ByVal EndDate As String, ByVal ShopIDList As String, ByVal SelMonth As Integer, ByVal SelYear As Integer, ByVal objCnn As MySqlConnection) As String
	Dim sqlStatement As String
    Dim AdditionalQuery,ExpenseQuery As String
	
	If SelMonth > 0 AND SelYear > 0 Then
		AdditionalQuery += " AND a.RevenueMonth=" + SelMonth.ToString + " AND a.RevenueYear=" + SelYear.ToString
		ExpenseQuery += " AND a.ExpenseMonth=" + SelMonth.ToString + " AND a.ExpenseYear=" + SelYear.ToString
	Else
	...
	If Trim(ShopIDList) <> "" Then
		...
		ExpenseQuery += " AND a.ShopID IN (" + ShopIDList + ")"
	End If
	
	ExpenseCategory = objDB.List("select count(*),c.ExpenseCategoryID,c.ExpenseCategoryName,c.Ordering from ExpenseShopData a, ExpenseData b, ExpenseCategory c where a.ExpenseDataID=b.ExpenseDataID AND b.ExpenseCategoryID=c.ExpenseCategoryID AND a.Deleted=0 " + ExpenseQuery + " group by c.ExpenseCategoryID,c.ExpenseCategoryName,c.Ordering order by c.ExpenseCategoryID,c.Ordering", objCnn)
	
	ExpenseData = objDB.List("select SUM(ExpenseAmount) As ExpenseAmount,a.ShopID,a.ExpenseMonth,a.ExpenseYear,c.ExpenseCategoryID,c.ExpenseCategoryName,c.Ordering from ExpenseShopData a, ExpenseData b, ExpenseCategory c where a.ExpenseDataID=b.ExpenseDataID AND b.ExpenseCategoryID=c.ExpenseCategoryID AND a.Deleted=0 " + ExpenseQuery + " group by a.ShopID,a.ExpenseMonth,a.ExpenseYear,c.ExpenseCategoryID,c.ExpenseCategoryName,c.Ordering", objCnn)
	
	dtTable = objDB.List("select * from RevenueSummary a left outer join ProductLevel pl ON a.ShopID=pl.ProductLevelID left outer join ShopExtData c ON a.ShopID=c.ShopID where 0=0 " + AdditionalQuery + " Order By pl.ProductLevelOrder, pl.ProductLevelCode", objCnn)
