...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("MonthlySummary") Then
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		ResultText.InnerHtml = getReport.MonthlyFinalcialReportB(dtTable,PaymentData,VoidData,TempTable,StartDate, EndDate, Request.Form("ShopID"),SelMonth, SelYear, objCnn)
		...
		SummaryText += "<tr>"
		SummaryText += "<td align=""left"" class=""" + TextClass + """>" & "PB1 10%" & "</td>"
		...
		ResultSearchText.InnerHtml = "Monthly Financial Report of " + ShopDisplay + " (" + ReportDate + ")"
