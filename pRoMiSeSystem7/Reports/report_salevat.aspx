...
Dim PageID As Integer = 13
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If FoundError = False Then
            ...
            Dim dtTable As DataTable = getReport.SaleVATReports(StartDate, EndDate, Request.Form("ShopID"), Session("LangID"), ViewOption, _
                                                   Session("StaffRole"), False, chkDisplayVoidReceipt.Checked, dtVoidReceipt, objCnn)
            ...
            Dim MaxRText, strVoidReceiptNo As String
            ...
            For i = 0 To dtTable.Rows.Count - 1
                ...
                'TotalSale = Format(dtTable.Rows(i)("TransactionVatable"), FormatData.Rows(0)("CurrencyFormat"))
                '                grandTotalBeforeVAT += TotalSale - Format(dtTable.Rows(i)("TransactionVAT"), FormatData.Rows(0)("CurrencyFormat"))
                '               grandTotalVAT += Format(dtTable.Rows(i)("TransactionVAT"), FormatData.Rows(0)("CurrencyFormat"))
                '              grandTotalAfterVAT += TotalSale
				
                '            POSTotalBeforeVAT += TotalSale - Format(dtTable.Rows(i)("TransactionVAT"), FormatData.Rows(0)("CurrencyFormat"))
                '          POSTotalVAT += Format(dtTable.Rows(i)("TransactionVAT"), FormatData.Rows(0)("CurrencyFormat"))
                ...
                ItemValString = TotalSale - Format(dtTable.Rows(i)("TransactionVAT"), FormatData.Rows(0)("CurrencyFormat"))
                ...
                If i <> dtTable.Rows.Count - 1 Then
                    If dtTable.Rows(i)("ComputerID") <> dtTable.Rows(i + 1)("ComputerID") Then
                        myDataRow = myDataTable.NewRow()
                        myDataRow("ItemName") = LangData2.Rows(15)(LangText) + " " + TerminalString
                        myDataRow("PriceBeforeVAT") = Format(POSTotalBeforeVAT, FormatData.Rows(0)("CurrencyFormat"))
