...
Sub Page_Load()
	If User.Identity.IsAuthenticated AND Session("Report_Prepaid") AND IsNumeric(Request.QueryString("CardID")) AND IsNumeric(Request.QueryString("ProductLevelID")) Then
		...
		Try		
			...
			If Not Page.IsPostBack Then
				...
				Dim dtTable As DataTable = getReport.PrepaidDetails(Request.QueryString("CardID"),Request.QueryString("ProductLevelID"),Session("LangID"),objCnn)
				...
				If ReceiptHeaderData.Rows.Count > 0 Then
					...
					End If
				End If
				HeaderText.InnerHtml = "Prepaid Details: " + Request.QueryString("MemberName")
