...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="Online Tax Report" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("OnlineTaxReport") Then
	...
	Try	
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>SaleNumber</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "ReceiptNumber" + "</td>"		
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "TransactionDate" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "AmountTransaksi" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "AmountService" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Tax" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "SaleDate" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "OutletCode" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "OutletName" + "</td>"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		End If
		ResultSearchText.InnerHtml = "Online Tax Report" + " " + ShopDisplay + " (" + ReportDate + ")"
		'Application.UnLock()
...
End Sub	
 ...
 Public Function OnlineTaxReport(ByRef dtTable As DataTable, ByVal StartDate As String, ByVal EndDate As String, ByVal ShopID As String, ByVal LangPath As String, ByVal StaffRoleID As Integer, ByVal objCnn As MySqlConnection) As String
        ...
        sqlStatement = "select *,CAST(SaleNumber AS CHAR(30)) As SaleNo,CAST(ReceiptNumber AS CHAR(30)) As ReceiptNo from onlinetax a where 0=0 " + AdditionalQuery + " order by OutletCode,SaleDate,ReceiptNumber"
		...
		For i = 0 To dtTable.Rows.Count - 1
			...
			outputString = outputString.Append("<td align=""left"" class=""" + TextClass + """>" + dtTable.Rows(i)("SaleNo").ToString + "</td>")
			outputString = outputString.Append("<td align=""left"" class=""" + TextClass + """>" + dtTable.Rows(i)("ReceiptNo").ToString + "</td>")
			outputString = outputString.Append("<td align=""center"" class=""" + TextClass + """>" + dtTable.Rows(i)("TransactionDate") + "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(dtTable.Rows(i)("AmountTransaksi")).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(dtTable.Rows(i)("AmountService")).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + CDbl(dtTable.Rows(i)("Tax")).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			outputString = outputString.Append("<td align=""center"" class=""" + TextClass + """>" + CDate(dtTable.Rows(i)("SaleDate")).ToString("dd/MM/yyyy", Invc) + "</td>")
			outputString = outputString.Append("<td align=""left"" class=""" + TextClass + """>" + dtTable.Rows(i)("OutletCode") + "</td>")
