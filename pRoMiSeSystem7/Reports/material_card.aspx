...
<tr id="ShowShop" runat="server">
	...
	<td colspan="6"><span id="ShopText" runat="server"></span></td>
</tr>
<tr>
...
<tr>
	...
	<td class="text" colspan="4"><asp:radiobutton ID="Radio_3" GroupName="Group2" runat="server" Checked="true" /> <asp:radiobutton ID="Radio_4" GroupName="Group2" runat="server" /></td>
</tr>
...
Sub Page_Load()
	...
	Try	
		...
		Radio_3.Text = "Group By Material"
		Radio_4.Text = "Group By Date"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Application.Lock()
		Dim dtTable As DataTable = getReport.MaterialReports(Radio_1.Checked, Radio_2.Checked, Radio_3.Checked, Radio_4.Checked, Request.Form("MonthYearDate_Month"), Request.Form("MonthYearDate_Year"), DateFromValue, DateToValue, Request.Form("ShopID"), objCnn)
		Application.UnLock()
		For i=0 To dtTable.Rows.Count - 1
			...
			If Radio_4.Checked = True
				If dtTable.Rows(i)("SaleDate") <> DummySaleDate Then
					...
					outputString += "<tr><td colspan=""4"" class=""tdHeader"" bgColor=""" + GlobalParam.AdminBGColor + """>" + ShowSaleDate + "</td></tr>"
				End If
			End If
			outputString += "<tr>"
			outputString += "<td align=""left"" class=""text"">" & dtTable.Rows(i)("MaterialCode") & "</td>"
			outputString += "<td align=""left"" class=""text"">" & dtTable.Rows(i)("MaterialName") & "</td>"
			outputString += "<td align=""right"" class=""text"">" & Format(dtTable.Rows(i)("TotalAmount"),"##,##0.00") & "</td>"
			outputString += "<td align=""right"" class=""text"">" & dtTable.Rows(i)("UnitSmallName") & "</td>"
