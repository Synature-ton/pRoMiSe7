...
Dim stReport As New Report()
		
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("Reports_BakeryGroup") Then
	...
	Try	
		...
		LangText0.Text = "Sale Report By Bakery Department"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	ElseIf Radio_2.Checked = True Then
		...
		If Trim(StartDate) = "InvalidDate" Or Trim(EndDate) = "InvalidDate" Then
			ResultSearchText.InnerHtml = "<table><tr><td class=""requireText"">" + "วันที่ไม่ถูกต้อง" + "</td></tr></table>"
			FoundError = True
			DateFromValue = ""
			DateToValue = ""
			DailyDateValue = ""
	...
	If FoundError = False Then
		'If LangDefault.Rows.Count >= 3 Then
			'CreateReportDate.Text = "วันที่สร้างรายงาน " & DateTimeUtil.FormatDateTime(NOW(), "DateAndTime",Session("LangID"),objCnn)
		'End If LangDefault.Rows(2)(LangText)
		...
		'Application.Lock()
		Dim dtTable As DataTable = stReport.SaleReportBakeryGroup(AllShopSum.Checked,1,outputString, grandTotal, VATTotal, GraphData, StartDate, EndDate, Request.Form("ShopID"),0,0, objCnn)

		stReport.GenOutputSaleByBakeryDept(outputString,grandTotal,VATTotal,False,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,dtTable,Request.Form("ShopID"),StartDate,EndDate,objCnn)
		...
		End If
		ResultSearchText.InnerHtml = "Sale Report By Bakery Department of " + ShopDisplay + " (" + ReportDate + ")"
		'Application.UnLock()
