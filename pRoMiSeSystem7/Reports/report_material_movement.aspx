	...
	If User.Identity.IsAuthenticated Then
	  ...
	  If NOT Request.QueryString("MaterialID") AND IsNumeric(Request.QueryString("MaterialID")) Then
		...
		Try
        	...
        	dtTable = getInfo.MaterialMovement(Request.QueryString("ProductLevelID"),MaterialID.Value,Request.QueryString("SelMonth"),Request.QueryString("SelYear"), Session("LangID"), objCnn)	
