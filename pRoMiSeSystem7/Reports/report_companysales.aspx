...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("Report_CompanySales") Then
	...
	'Try	
		...
		LangText0.Text = "Company Sales Report"'LangData2.Rows(16)(LangText)
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Dim i As Integer
		Dim dtTable As DataTable = CompanySalesReport(StartDate, EndDate, Request.Form("ShopID"), objCnn)
		...
		End If
		ResultSearchText.InnerHtml = "Sales Report for Company" + " " + ShopDisplay + " (" + ReportDate + ")"
...
Sub ExportData(Source As Object, E As EventArgs)
	...
	Dim FileName As String = "CompanySalesData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
...
Public Function CompanySalesReport(ByVal StartDate As String, ByVal EndDate As String, ByVal CompanyCode As String, ByVal objCnn As MySqlConnection) As DataTable
