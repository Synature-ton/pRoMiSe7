...
<tr id="ShowShop" runat="server">
	...
	<table>
		...
		<td colspan="2"><asp:CheckBox ID="ExpandReceipt" CssClass="text" Checked="false" Visible="false" runat="server" /><asp:CheckBox ID="ShowSummary" CssClass="text" Checked="True" Visible="false" Text="Show Summary Statistics" runat="server" /></td>
		</tr>
		<tr>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("Sale_Report_ByTime2") Then
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		If Request.Form("ShopID") > 0 Or (Request.Form("ShopID")=0 AND R12 = True) Then
			...
			ResultText.InnerHtml = getReport.SaleReports(PayTypeList,outputString, grandTotal, VATTotal, GraphData, True,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, Request.Form("GroupByParam"), StartDate, EndDate, Request.Form("FromTime_Hour"), Request.Form("FromTime_Minute"), Request.Form("ToTime_Hour"),Request.Form("ToTime_Minute"), Request.Form("ShopID"),0,0,ShowStat,ExpReceipt, DGraph,1, objCnn)
		...
		End If
		ResultSearchText.InnerHtml = "Sale Report By Time of " + ShopDisplay + " (" + ReportDate + ReportTime + ")"
		'Application.UnLock()
