...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		dtTable = pRoMiSeReport.CreateHistoryOfOrderReport(objCnn, Request.Form("ShopID"), StartDate, EndDate, Request.Form("FrontSystemType"), 999, MoveTable, MoveOrder, DelOrder)
		Dim displayTable As DataTable 
		displayTable = pRoMiSeReport.CreateHistoryOrderReportDataTable(dtTable, Request.Form("ShopID"), Session("LangID"), objCnn)
