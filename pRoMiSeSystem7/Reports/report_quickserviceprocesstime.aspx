...
<html>
<head>
<title>Quick Service Pricess Time</title>
...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="รายงานเวลาในการทำรายการ" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
<script language="VB" runat="server">
    ...
    Dim quickserviceProcessTimePageID As Integer = 108
    ...
    Sub Page_Load()
        If User.Identity.IsAuthenticated And Session("Report_Sale_New") Then
            ...
            Try
                ...
                Dim LangData As DataTable = getProp.GetLang(LangListText, LangListData, PageName & "?ID" & Request.QueryString("ID") & "&Order=" + Request.QueryString("Order") & "&GroupID=" & Request.QueryString("GroupID"), quickserviceProcessTimePageID, 1, -1, Request, objCnn)
                ...
                Dim dtProcessTimeLangData As DataTable = getProp.GetLangData(quickserviceProcessTimePageID, 2, -1, Request)
                ...
                LangText0.Text = BackOfficeReport.GetLanguageText(dtProcessTimeLangData, 15, LangText, "Quick Service Process Time Report")
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        ReportType = BackOfficeReport.GetLanguageText(dtProcessTimeLangData, 15, LangText, "Quick Service Process Time Report")
        ReportDate = ""
        StartDate = ""
        EndDate = ""
        ...
        If FoundError = False Then
            ...
            ResultText.InnerHtml = reports.ReceiptProcessTimeReport(objCnn, GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, Session("LangID"), _
                                  StartDate, EndDate, SelShopIDList.Value, viewReportBy, ViewProcessTimeReportType.QuickServiceProcessTime, _
                                  LangPath, Session("StaffID"))
        End If
            'Application.UnLock()
    ...
    Sub ExportData(Source As Object, E As EventArgs)
        Dim FileName As String = "QuickServiceProcessTimeData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
