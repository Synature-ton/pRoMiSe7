...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="End Day Report" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		ResultText.InnerHtml = getReport.SessionReportsB(dtTable, PaymentResult, GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption, StartDate, EndDate, Request.Form("ShopID"), 0, 0, objCnn)
		ResultSearchText.InnerHtml = "End Day Report of " + SelShopName.Value + " (" + ReportDate + ")"
		'Application.UnLock()
...
Sub ExportData(Source As Object, E As EventArgs)
	...
	Dim FileName As String = "EndDayReport_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
