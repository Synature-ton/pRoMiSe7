...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="Qty Mix Report" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
Sub Page_Load()
	...
	Try	
		...
		Radio_12.Text = "Qty Mix Report"'LangData2.Rows(1)(LangText)
		Radio_13.Text = "Qty Mix Hour"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If Request.Form("Group2") = "Radio_11" Then
		R11 = True
		ReportType = "O.C. Qty Mix Report"
	ElseIf Request.Form("Group2") = "Radio_12" Then
		R12 = True
		ReportType = "Qty Mix Report"'LangData2.Rows(15)(LangText)
	ElseIf Request.Form("Group2") = "Radio_13" Then
		R13 = True
		If Request.Form("GroupByParam") = 1 Then
			ReportType = "Qty Mix By Hour"'LangData2.Rows(16)(LangText)
		Else
			ReportType = "Qty Mix By Hour"'LangData2.Rows(17)(LangText)
		End If
	End If
...
Sub ExportData(Source As Object, E As EventArgs)
	...
	If Radio_12.Checked = True Then
		FileName = "QtyMixData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
	Else
		FileName = "QtyMixByHourData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
	End If
...
End Sub	
 ...
 Public Function SaleQtyMixReports(ByRef HourlyData As DataTable, ByRef IncomeType As DataTable, ByRef PayTypeList As DataTable, ByRef outputString As String, ByRef grandTotal As Double, ByRef VATTotal As Double, ByRef GraphData As DataSet, ByVal ShowSummary As Boolean, ByVal GrayBGColor As String, ByVal AdminBGColor As String, ByVal LangID As Integer, ByVal ViewOption As Integer, ByVal ReportByBill As Boolean, ByVal ReportByProduct As Boolean, ByVal ReportByTime As Boolean, ByVal GroupByParam As Integer, ByVal StartDate As String, ByVal EndDate As String, ByVal StartTimeHour As String, ByVal StartTimeMinute As String, ByVal EndTimeHour As String, ByVal EndTimeMinute As String, ByVal ShopID As String, ByVal TransactionID As Integer, ByVal ComputerID As Integer, ByVal DisplaySummary As Boolean, ByVal ExpandReceipt As Boolean, ByVal DisplayGraph As Boolean, ByVal LangPath As String, ByVal BySaleMode As Boolean, ByVal StaffRoleID As Integer, ByVal objCnn As MySqlConnection) As String
        ...
        Else
            BranchStr = ""
        End If
        Dim PName As String = "IF(TRIM(p.ProductName1) <> '',p.ProductName1,p.ProductName) As ProductName"
        Dim PName2 As String = "IF(TRIM(p.ProductName1) <> '',p.ProductName1,p.ProductName)"
        Dim SaleModePName As String = PName2 + " As ProductName"
        ...
        If ReportByProduct = True Or ReportByBill = True Then
            TimeNow += "<BR>" + DateTimeUtil.CurrentDateTime
                ...
                SaleQtyMixReportByProduct(BySaleMode, SMData, PromotionData, ProductData, GraphData, outputString, grandTotal, VATTotal, ShowSummary, GrayBGColor, AdminBGColor, ShopIDListValue, ViewOption, StartDate, EndDate, GetData, PaymentData, PayByCreditMoney, LangID, LangPath, objCnn)
                TimeNow += "<BR>" + DateTimeUtil.CurrentDateTime
        ...
        Else
				...
				sqlStatement = "SELECT 0 As Hourl,a.TransactionStatusID,a.OtherFoodName,a.VATType, IF(a.ProductBarcode is NULL,a.ProductCode,a.ProductBarCode) As ProductCode,IF(TRIM(a.ProductName1) <> '',a.ProductName1,a.ProductName) As ProductName, a.ProductDeptName,a.ProductGroupName,a.ProductGroupCode,a.ProductDeptCode,a.GroupOrdering,a.DeptOrdering,SUM(a.Amount) AS Amount,SUM(a.TotalPrice) AS TotalPrice,SUM(a.TotalRetailPrice) AS TotalRetailPrice,SUM(SalePrice) AS SalePrice FROM Summary_SaleHourlyProduct a WHERE a.Hourly >= 0 AND a.Hourly <= 6 AND a.OrderStatusID IN (1,2,5) " + AdditionalQuery + "  GROUP BY a.TransactionStatusID,a.OtherFoodName,a.VATType, a.ProductBarCode,a.ProductName1, a.ProductDeptName,a.ProductGroupName,a.ProductGroupCode,a.ProductDeptCode " + "UNION" + " SELECT a.Hourly,a.TransactionStatusID,a.OtherFoodName,a.VATType, IF(a.ProductBarcode is NULL,a.ProductCode,a.ProductBarCode) As ProductCode,IF(TRIM(a.ProductName1) <> '',a.ProductName1,a.ProductName) As ProductName, a.ProductDeptName,a.ProductGroupName,a.ProductGroupCode,a.ProductDeptCode,a.GroupOrdering,a.DeptOrdering,SUM(a.Amount) AS Amount,SUM(a.TotalPrice) AS TotalPrice,SUM(a.TotalRetailPrice) AS TotalRetailPrice,SUM(SalePrice) AS SalePrice FROM Summary_SaleHourlyProduct a WHERE a.Hourly >= 7 AND a.OrderStatusID IN (1,2,5) " + AdditionalQuery + "  GROUP BY a.TransactionStatusID,a.OtherFoodName,a.VATType, a.ProductBarCode,a.ProductName1, a.ProductDeptName,a.ProductGroupName,a.ProductGroupCode,a.ProductDeptCode,a.Hourly "
				
				objDB.sqlExecute("DROP TABLE IF EXISTS DummySaleMixHourly_" + ExtraTableString, objCnn)
        		objDB.sqlExecute("create table DummySaleMixHourly_" + ExtraTableString + " (Hourly int, TransactionStatusID smallint,OtherFoodName varchar(100), VATType tinyint, ProductCode varchar(50),ProductName varchar(255),ProductDeptName varchar(100),ProductGroupName varchar(100),ProductGroupCode varchar(50),ProductDeptCode varchar(50), GroupOrdering int, DeptOrdering int, Amount decimal(18,4), TotalPrice decimal(18,4), TotalRetailPrice decimal(18,4), SalePrice decimal(18,4))", objCnn)
				...
				SaleQtyMixHourlyReportByProduct(BySaleMode, HourlyData, PromotionData, ProductData, GraphData, outputString, grandTotal, VATTotal, ShowSummary, GrayBGColor, AdminBGColor, ShopIDListValue, ViewOption, StartDate, EndDate, GetData, PaymentData, PayByCreditMoney, LangID, LangPath, objCnn)
                TimeNow += "<BR>" + DateTimeUtil.CurrentDateTime
    ...
    Public Function SaleQtyMixReportByProduct(ByVal BySaleMode As Boolean, ByVal SMData As DataTable, ByVal PromotionData As DataTable, ByVal ProductData As DataTable, ByRef GraphData As DataSet, ByRef ResultString As String, ByRef grandTotal As Double, ByRef VATTotal As Double, ByVal ShowSummary As Boolean, ByVal GrayBGColor As String, ByVal AdminBGColor As String, ByVal ShopID As String, ByVal ViewOption As Integer, ByVal StartDate As String, ByVal EndDate As String, ByVal dtTable As DataTable, ByVal PaymentResult As DataTable, ByVal PayByCreditMoney As DataTable, ByVal LangID As Integer, ByVal LangPath As String, ByVal objCnn As MySqlConnection) As String
		...
		Dim ColSpan As String = (SMData.Rows.Count+6).ToString
		Dim ColSpan2 As String = (SMData.Rows.Count+3).ToString
		Dim ColSpan3 As String = (SMData.Rows.Count+6).ToString
		Dim foundRows() As DataRow
        Dim expression As String
		Dim groupTotalQty As Double
		If dtTable.Rows.Count > 0 Then
			TotalQty = dtTable.Compute("SUM(Amount)","")
		End If
		Dim sumTotalQty As Double = 0
		...
		For i = 0 To ProductData.Rows.Count - 1
			If i = 0 Then
				...
				sumTotalQty = dtTable.Compute("SUM(Amount)","ProductDeptCode='" + ProductData.Rows(i)("ProductDeptCode") + "' AND ProductGroupCode='" + ProductData.Rows(i)("ProductGroupCode") + "'")
			...
			For j = 0 To SMData.Rows.Count - 1
				...
				'Try
				expression = "ProductCode='" + ProductData.Rows(i)("ProductCode").ToString + "' AND SaleMode=" + SMData.Rows(j)("SaleModeID").ToString + " AND VATType=" + ProductData.Rows(i)("VATType").ToString + " AND ProductName='" + Replace(ProductData.Rows(i)("ProductName"),"'","''").ToString + "'"
				foundRows = dtTable.Select(expression)
				'Catch ex As Exception
					'TestString += "<BR>" + "ProductCode='" + ProductData.Rows(i)("ProductCode").ToString + "' AND SaleMode=" + SMData.Rows(j)("SaleModeID").ToString + " AND VATType=" + ProductData.Rows(i)("VATType").ToString
				'End Try
			...
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & CDbl(SaleModeQty/sumTotalQty).ToString(FormatObject.PercentFormat, ci) & "</td>")
			...
			If i = ProductData.Rows.Count - 1
				groupTotalQty = dtTable.Compute("SUM(Amount)","ProductGroupCode='" + ProductData.Rows(i)("ProductGroupCode") + "'")
				outputString = outputString.Append("<tr bgColor=""" + bgColor + """>")
				...
				outputString = outputString.Append("<td align=""right"" class=""" + SummaryText + """>" + CDbl((subTotalQty / groupTotalQty)).ToString(FormatObject.PercentFormat, ci) + "</td>")
				...
				outputString = outputString.Append("<td align=""right"" class=""" + SummaryText + """>" + CDbl((subTotalGroupQty / TotalQty)).ToString(FormatObject.PercentFormat, ci) + "</td>")
				outputString = outputString.Append("<td></td></tr>")
			Else
	...
	Public Function SaleQtyMixHourlyReportByProduct(ByVal BySaleMode As Boolean, ByVal HourlyData As DataTable, ByVal PromotionData As DataTable, ByVal ProductData As DataTable, ByRef GraphData As DataSet, ByRef ResultString As String, ByRef grandTotal As Double, ByRef VATTotal As Double, ByVal ShowSummary As Boolean, ByVal GrayBGColor As String, ByVal AdminBGColor As String, ByVal ShopID As String, ByVal ViewOption As Integer, ByVal StartDate As String, ByVal EndDate As String, ByVal dtTable As DataTable, ByVal PaymentResult As DataTable, ByVal PayByCreditMoney As DataTable, ByVal LangID As Integer, ByVal LangPath As String, ByVal objCnn As MySqlConnection) As String
		...
		Dim ColSpan As String = (HourlyData.Rows.Count+6).ToString
		Dim ColSpan2 As String = (HourlyData.Rows.Count+3).ToString
		Dim ColSpan3 As String = (HourlyData.Rows.Count+6).ToString
		Dim foundRows() As DataRow
        Dim expression As String
		
		Dim sumTotalQty As Double
		Dim groupTotalQty As Double
		If dtTable.Rows.Count > 0 Then
			totalQty = dtTable.Compute("SUM(Amount)","")
		End If
		...
		For i = 0 To ProductData.Rows.Count - 1
			...
			For j = 0 To HourlyData.Rows.Count - 1
				...
				expression = "ProductCode='" + ProductData.Rows(i)("ProductCode").ToString + "' AND VATType=" + ProductData.Rows(i)("VATType").ToString + " AND ProductName='" + Replace(ProductData.Rows(i)("ProductName"),"'","''").ToString + "'" + AdditionalQuery
