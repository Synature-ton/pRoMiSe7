...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("SaleVATReportB") Then
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		'Application.Lock()
		Dim dtTable As DataTable = getReport.SaleVATReports_A(StartDate, EndDate, Request.Form("ShopID"), Session("LangID"), ViewOption, objCnn)
