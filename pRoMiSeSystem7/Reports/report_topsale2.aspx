...
<tr id="ShowShop" runat="server">
	...
	<tr><td>&nbsp;</td>
		<td colspan="4" class="text"><asp:button ID="SubmitForm" Font-Size="8" Height="20" Width="110" OnClick="DoSearch" runat="server" />&nbsp;<asp:CheckBox ID="DisplayGraph" CssClass="text" Checked="false" runat="server" />&nbsp;&nbsp;Display <asp:TextBox ID="NumDisplay" CssClass="text" Width="30" Text="10" runat="server"></asp:TextBox> record(s)</td>
	</tr>
	</table>
	</td>
</tr>
...
Sub Page_Load()
	...
	Try	
		...
		If MySQL5Report = True Then
			Response.Redirect("report_topsale2_mysql5.aspx")
		End If
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		getReport2.TopSaleReports(dtTable,grandTotalQty,grandTotal,GraphData,GroupByParam.SelectedItem.Value, StartDate, EndDate, StartTime, EndTime, ShopInfo.SelectedItem.Value,GroupInfo.SelectedItem.Value,DeptInfo.SelectedItem.Value,NumDisplay.Text, DisplayGraph.Checked, Session("LangID"),"", 2, objCnn)
