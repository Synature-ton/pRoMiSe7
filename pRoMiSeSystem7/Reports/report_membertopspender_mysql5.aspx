...
<html>
<head>
<title>Member Top Spender Reports</title>
...
<tr id="ShowShop" runat="server">
	<td valign="top">
		<table>
            ...
            <tr>
            	<td class="text">Top <asp:TextBox ID="Top" Width="50" Text="10" runat="server"></asp:TextBox></td>
			<tr>
...
Sub Page_Load()
	...
	Try	
		...
		HeaderText.InnerHtml = "Member Statistics Top Spender Report"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Dim MemberData As New DataTable()
		Dim FavoriteBranch As DataTable
		'Application.Lock()
		Dim Result As String = getReport.MemberTopSpenderReport(MemberData,FavoriteBranch,TopValue, Request.Form("ShopID"),StartDate, EndDate, objCnn)
		'Application.UnLock()
		...
		ResultSearchText.InnerHtml = ReportHeader + "Member Statistics Top Spender (" + ReportDate + ")"
		Dim i As Integer
		...
		HeaderString += "<tr>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Rank</td>"		
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Favorite Branch</td>"
		...
		For i = 0 To MemberData.Rows.Count - 1
			outputString = outputString.Append("<tr>")
			outputString = outputString.Append("<td class=""smallText"" align=""center"">" + (i+1).ToString + "</td>")
			outputString = outputString.Append("<td class=""smallText"" align=""left"">" + MemberData.Rows(i)("MemberCode") + "</td>")
			outputString = outputString.Append("<td class=""smallText"" align=""left"">" + "<a href=""JavaScript: newWindow = window.open( '../members/member_stat.aspx?MemberID=" + MemberData.Rows(i)("MemberID").ToString + "', '', 'width=950,height=700,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()"">" & MemberData.Rows(i)("MemberFullName") & "</a>" + "</td>")
			expression = "MemberID=" + MemberData.Rows(i)("MemberID").ToString 
			foundRows = FavoriteBranch.Select(expression)
			If foundRows.GetUpperBound(0) >= 0 Then
				outputString = outputString.Append("<td class=""smallText"" align=""left"">" + foundRows(0)("ShopName") + "</td>")
			Else
				outputString = outputString.Append("<td class=""smallText"" align=""left"">" + "-" + "</td>")
			End If
			outputString = outputString.Append("<td class=""smallText"" align=""right"">" + Format(MemberData.Rows(i)("TotalBill"),"##,##0;(##,##0)")  + "</td>")
			outputString = outputString.Append("<td class=""smallText"" align=""right"">" + "<a href=""JavaScript: newWindow = window.open( 'member_purchase_stat_mysql5.aspx?MemberID=" + MemberData.Rows(i)("MemberID").ToString + AttachString + "', '', 'width=800,height=700,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()"">" + Format(MemberData.Rows(i)("TotalPaid"),"##,##0.00;(##,##0.00)") + "</a></td>")
		Next
