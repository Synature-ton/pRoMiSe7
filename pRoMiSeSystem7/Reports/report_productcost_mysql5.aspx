...
<%@Import Namespace="CostingClassMySQL5.pRoMiSeCosting" %>
...
Sub Page_Load()
	...
	Try	
		...
		HeaderText.InnerHtml = "Sale and Cost Report By Products"
		...
		Dim ShopData As DataTable = CostInfo.GetProductLevelAccess(-999,Session("StaffRole"),objCnn)
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		ResultText.InnerHtml = getReport.SaleCostReportByProduct(PayTypeList,outputString, grandTotal, VATTotal, GraphData, True,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, Request.Form("GroupByParam"), StartDate, EndDate, Request.Form("ShopID"),0,0,True,SelMonth, SelYear, objCnn)
