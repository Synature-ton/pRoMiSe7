...
<%@Import Namespace="pRoMiSeCRM.pRoMiSeCRM" %>
...
<table border="0" cellpadding="4" cellspacing="0">
	...
	<tr>
		<td><asp:Button ID="ExportExcelAll" OnClick="ExportToExcelAll" Height="20" Font-Size="8" Width="140" Text="Export Member Data" Visible="false" runat="server"></asp:Button></td>
		<td><asp:Button ID="ExportUserDefine" OnClick="ExportMemberUDD" Height="20" Font-Size="8" Width="140" Text="Export User Define Data" Visible="false" runat="server"></asp:Button></td>
	</tr>
</table>
</div>
...
<table id="" width="100%">
<tr><td colspan="2"><div class="noprint"><a href="javascript: window.print()">Print Report</a> | <asp:LinkButton ID="Export" Text="Export to Excel" OnClick="ExportFavData" runat="server" Visible="true"></asp:LinkButton></div></td></tr>
<tr><td align="left">
...
<table id="" width="100%">
<tr><td colspan="2"><div class="noprint"><table><tr><td><a href="javascript: window.print()">Print Report</a></td><td><asp:LinkButton ID="ExportSale" Text="Export to Excel" OnClick="ExportData" runat="server" Visible="false"></asp:LinkButton></td></tr></table></div></td></tr>
<tr><td align="left">
...
Dim PageID As Integer  = 998
    ...
    Public Function GenSaleResult(ByVal objCnn As MySqlConnection) As String
        ...
        For i = 0 To ShopList.Items.Count - 1
            If ShopList.Items(i).Selected = True Then
        ...
        Dim MCode, MFullName, MAmount, MBill, MMobile As String
        Dim strTemp As String
        MCode = "Member Code"
        MFullName = "Member Name"
        MMobile = "Mobile Number"
        ...
        myDataColumn = New DataColumn()
        myDataColumn.DataType = System.Type.GetType("System.String")
        myDataColumn.ColumnName = MMobile
        myDataTable.Columns.Add(myDataColumn)
		
        myDataColumn = New DataColumn()
        myDataColumn.DataType = System.Type.GetType("System.String")
        myDataColumn.ColumnName = MBill
        myDataTable.Columns.Add(myDataColumn)
        ...
        For i = 0 To dtTable.Rows.Count - 1
            ...
            Else
                If StartAmountVal = 0 And EndAmountVal = 0 Then
                    DisplayRecord = True
                Else
                    Select Case FilterSaleCriteria.SelectedItem.Value
                        Case "="
            ...
            If DisplayRecord = True Then
                ...
                strTemp = ""
                If Not IsDBNull(dtTable.Rows(i)("MemberMobile")) Then
                    strTemp = Trim(dtTable.Rows(i)("MemberMobile"))
                End If
                If Not IsDBNull(dtTable.Rows(i)("MemberTelephone")) Then
                    If Trim(dtTable.Rows(i)("MemberTelephone")) <> "" Then
                        If strTemp <> "" Then
                            strTemp &= ", "
                        End If
                        strTemp &= Trim(dtTable.Rows(i)("MemberTelephone"))
                    End If
                End If
                myDataRow(MMobile) = strTemp
                
                myDataRow(MBill) = Format(dtTable.Rows(i)("TotalBill"), "##,##0")
        ...
        'SaleResults.RenderControl(htw)
		
        'Session("ReportResult") = "<table><tr><td>" & sw.ToString() & "</td></tr></table>"
		
        ExportSale.Visible = True

    End Function

    Sub ExportData(Source As Object, E As EventArgs)
	
        Dim FileName As String = "MemberSaleData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
        ...
        outputString = outputString.Append("<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "#" + "</td>")
        outputString = outputString.Append("<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Member Code" + "</td>")
        outputString = outputString.Append("<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Member Name" + "</td>")
        outputString = outputString.Append("<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Mobile Number" + "</td>")
        outputString = outputString.Append("<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Total Bill" + "</td>")
        outputString = outputString.Append("<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Purchase Amount" + "</td>")
        outputString = outputString.Append("</tr>")
        Dim i As Integer
        Dim strTemp As String
        For i = 0 To dtTable.Rows.Count - 1
            ...
            outputString = outputString.Append("<td align=""left"" class=""smallText"">" + (i + 1).ToString + "</td>")
            outputString = outputString.Append("<td align=""left"" class=""smallText"">" + dtTable.Rows(i)("MemberCode") + "</td>")
            outputString = outputString.Append("<td align=""left"" class=""smallText"">" + dtTable.Rows(i)("MemberFullName") + "</td>")
            ...
            outputString = outputString.Append("<td align=""right"" class=""smallText"">" + Format(dtTable.Rows(i)("TotalBill"), "##,##0") + "</td>")
            outputString = outputString.Append("<td align=""right"" class=""smallText"">" + Format(dtTable.Rows(i)("TotalSale"), "##,##0.00") + "</td>")
            outputString = outputString.Append("</tr>")
        Next
...
Sub ExportFavData(Source As Object, E As EventArgs)
	...
	Dim FileName As String = "MemberFavoriteData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
...
Sub ShowGroup()
	...
	gpTable = getInfo.GetProductGroupCodeNew(ShopInfo.SelectedItem.Value,0,objCnn)
...
Sub ShowGroup1()
	Dim i As Integer
	Dim gpTable As New DataTable()
	gpTable = getInfo.GetProductGroupNew(ShopInfo1.SelectedItem.Value,0,objCnn)
...
End Sub
    ...
    Private Sub SaleResults_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
        If e.Item.ItemType = ListItemType.Header Then
            ...
            e.Item.Cells(3).Text = "Mobile Number"
            e.Item.Cells(4).Text = "Total Bill"
            e.Item.Cells(5).Text = "Purchase Amount"
        End If
    End Sub
...
Try 
	Dim BatchNumber As String = System.Guid.NewGuid.ToString()
	Dim TimeNow As String
	objDB.sqlExecute("CREATE TABLE IF NOT EXISTS MarketingEmailQueue (ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT,EmailFrom varchar(100) NULL,EmailTo varchar(100),EmailSubject varchar(200),EmailBody text,EmailStatus tinyint,Remark text, BatchNumber varchar(200), InsertDateTime datetime, SendDateTime datetime) TYPE=INNODB;",objCnn)
	
	objDB.sqlExecute("CREATE TABLE IF NOT EXISTS MarketingEmail (ID INT NOT NULL PRIMARY KEY,EmailFrom varchar(100) NULL,EmailTo varchar(100),EmailSubject varchar(200),EmailBody text,EmailStatus tinyint,Remark text, BatchNumber varchar(200), InsertDateTime datetime, SendDateTime datetime) TYPE=INNODB;",objCnn)
	...
	For i = 0 To dtTable.Rows.Count - 1
	  If Not IsDBNull(dtTable.Rows(i)("EmailAddress")) Then
		If System.Text.RegularExpressions.Regex.IsMatch(Trim(dtTable.Rows(i)("EmailAddress")), strPattern) = True Then
			...
			objDB.sqlExecute("INSERT INTO MarketingEmailQueue (EmailFrom,EmailTo,EmailSubject,EmailBody,EmailStatus,Remark,BatchNumber,InsertDateTime,SendDateTime) values ('" + Replace(EmailFrom,"'","''") + "','" + Replace(Trim(dtTable.Rows(i)("EmailAddress")),"'","''") + "','" + Replace(EmailSubject,"'","''") + "','" + Replace(EmailMessage,"'","''") + "',0,'','" + BatchNumber + "'," + TimeNow + ",NULL)", objCnn)
	...
	Return "Message has been sent to queue the following recipients:" + EmailList
