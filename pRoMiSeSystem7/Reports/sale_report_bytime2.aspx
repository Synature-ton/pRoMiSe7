...
Sub Page_Load()
	...
	Try	
		...
		If MySQL5Report = True Then
			Response.Redirect("sale_report_bytime2_mysql5.aspx")
		End If
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		If Request.Form("ShopID") > 0 Or (Request.Form("ShopID")=0 AND R12 = True) Then
			...
			ResultText.InnerHtml = getReport2.SaleReportsByTime(PayTypeList,outputString, grandTotal, VATTotal, GraphData, True,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, Request.Form("GroupByParam"), StartDate, EndDate, Request.Form("FromTime_Hour"), Request.Form("FromTime_Minute"), Request.Form("ToTime_Hour"),Request.Form("ToTime_Minute"), Request.Form("ShopID"),0,0,True,ExpReceipt, DGraph, 2, objCnn)
