...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	Dim MonthStringList() As String = { "nodata","Á¡ÃÒ¤Á","¡ØÁÀÒ¾Ñ¹¸ì","ÁÕ¹Ò¤Á","àÁÉÒÂ¹","¾ÄÉÀÒ¤Á","ÁÔ¶Ø¹ÒÂ¹","¡Ã¡®Ò¤Á","ÊÔ§ËÒ¤Á","¡Ñ¹ÂÒÂ¹","µØÅÒ¤Á","¾ÄÈ¨Ô¡ÒÂ¹","¸Ñ¹ÇÒ¤Á" }
	...
	If FoundError = False Then
		...
		Dim DateString,InvoiceString,CustomerString,ItemString,ItemValString,VatString,ItemSubTotalString,NoteString As String
		...
		For i = 0 To dtTable.Rows.Count - 1
			...
			If ViewOption = 3 Then
				...
				InvoiceString =  "<a href=""JavaScript: newWindow = window.open( 'BillDetails.aspx?ComputerID=" + dtTable.Rows(i)("ComputerID").ToString + "&TransactionID=" + dtTable.Rows(i)("TransactionID").ToString + "', '', 'width=750,height=600,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()"" class=""smallText"">" & RText & VoidText & "</a>"
				
				DummyHeader = GlobalFTHeaderText
				...
				End If
				DateString = dtTable.Rows(i)("SaleDate").Day.ToString + " " + MonthStringList(dtTable.Rows(i)("SaleDate").Month) + " " + (dtTable.Rows(i)("SaleDate").Year+543).ToString'DateTimeUtil.FormatDateTime(dtTable.Rows(i)("SaleDate"), "DateOnly")
