...
<html>
<head>
<title>Search Bills by Table</title>
...
<tr id="ShowShop" runat="server">
	<td valign="top">
		<table>
			...
			<tr id="ShowOrderNo" visible="false" runat="server">
...
<tr><td>
	...
	<asp:DataGrid ID="Results" AutoGenerateColumns="false" CellPadding="3" CssClass="smalltext" HeaderStyle-BackColor="#507093" HeaderStyle-CssClass="smallTdHeader" HeaderStyle-HorizontalAlign="center" AllowPaging="false" OnItemDataBound="Results_ItemDataBound"  runat="server">
		<columns>
			...
			<asp:BoundColumn ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="smallText" DataField="OrderNoList"></asp:BoundColumn>
			<asp:BoundColumn ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="smallText" DataField="ReceiptNumber"></asp:BoundColumn> 
			<asp:BoundColumn ItemStyle-HorizontalAlign="right" ItemStyle-CssClass="smallText" DataField="TotalSale"></asp:BoundColumn> 
			<asp:BoundColumn ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="smallText" DataField="SaleDate"></asp:BoundColumn>  
			<asp:BoundColumn ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="smallText" DataField="OpenTime"></asp:BoundColumn> 
			<asp:BoundColumn ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="smallText" DataField="OpenBy"></asp:BoundColumn>  
			<asp:BoundColumn ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="smallText" DataField="PaidTime"></asp:BoundColumn>
			<asp:BoundColumn ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="smallText" DataField="PaidBy"></asp:BoundColumn> 
		</columns>
	</asp:DataGrid>
</td></tr>
</table></span>
...
Dim PageID As Integer  = 998
    ...
    Sub Page_Load()
        ...
        If User.Identity.IsAuthenticated And Session("Report_SearchByTable") Then
            ...
            Try
                ...
                LangText0.Text = "Search Bill By Table"
                ...
                If ShopData.Rows.Count > 0 Then
                    ...
                    outputString = "<select name=""ShopID"" onchange=""javascript:submit();"">"
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If FoundError = False Then
            ...
            'Application.Lock()
            Dim dtTable As DataTable = getReport.SearchReportByTable(Session.SessionID, StartDate, EndDate, Request.Form("ShopID"), Request.Form("TableID"), Session("LangID"), objCnn)
            'Application.UnLock()
            ...
            ResultSearchText.InnerHtml = "Search Results By Table of " + ShopDisplay + " (" + ReportDate + ")"
		
            Dim displayTable As DataTable
            displayTable = getReport.CreateSearchTableReportDataTable(dtTable, Session("LangID"), objCnn)
    ...
    Private Sub Results_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Header Then
            e.Item.Cells(0).Text = "Table"
            e.Item.Cells(1).Text = "Order Number"
            e.Item.Cells(2).Text = "Receipt #"
            e.Item.Cells(3).Text = "Total Sale"
            e.Item.Cells(4).Text = "Receipt Date"
            e.Item.Cells(5).Text = "Open Time"
            e.Item.Cells(6).Text = "Opened By"
            e.Item.Cells(7).Text = "Paid Time"
            e.Item.Cells(8).Text = "Paid By"
        End If
    End Sub

    Sub ExportData(Source As Object, E As EventArgs)
	
        Dim FileName As String = "SearchByTable_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
