...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Dim dtTable As DataTable = getReport.SaleReportByDept(ShowGroup.Checked,outputString, grandTotal, VATTotal, GraphData, PaymentResult, PayByCreditMoney, StartDate, EndDate, Request.Form("ShopID"),0,0,Session("LangID"),LangPath, objCnn)
		...
		End If
		ResultSearchText.InnerHtml = LangData2.Rows(11)(LangText) + " " + ShopDisplay + " (" + ReportDate + ")"
