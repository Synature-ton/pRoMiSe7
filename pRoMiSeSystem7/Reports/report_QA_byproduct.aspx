...
<html>
<head>
<title>Sale Reports By PLU</title>
...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="Sale Report By PLU" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("QAReportByProduct") Then
	...
	Try	
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "PLU#" + "</td>"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Application.Lock()
		Dim dtTable As DataTable = getReport.QASaleReportByPLU(ShowGroup.Checked,outputString, outString2, StartDate, EndDate, Request.Form("ShopID"),0,0, "pg.ProductGroupCode,pd.ProductDeptCode,p.ProductCode", GlobalParam.AdminBGColor, objCnn)
		...
		End If
		ResultSearchText.InnerHtml = "Sale Report By PLU of " + ShopDisplay + "<br>" + ReportDate + ""
...
Sub ExportData(Source As Object, E As EventArgs)
	...
	Dim FileName As String = "SaleByProduct_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
