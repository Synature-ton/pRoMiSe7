...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Application.Lock()
		Dim dtTable As DataTable = getReport.DocumentByGroupReport(TableNameString,Request.Form("ShopID"),Request.Form("DocumentTypeGroupID"), StartDate, EndDate, SelMonth, SelYear, Session("LangID"), "", objCnn)
		Application.UnLock()
			...
			For j = 0 To DocData.Rows.Count - 1
				...
				For k = 0 To MGroupData.Rows.Count - 1
					...
					If DocDetailData.Rows.Count > 0 Then
						If DocDetailData.Rows(0)("ProductLevelID") = CalculateFromShopID AND (Request.Form("DocumentTypeGroupID") = 0 Or Request.Form("DocumentTypeGroupID") = 1 OR DocDetailData.rows(0)("DocumentTypeID")=46) Then
