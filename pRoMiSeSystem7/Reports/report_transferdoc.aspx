...
<html>
<head>
<title>Transfer Document Reports</title>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("Reports_TransferDoc") Then
	...
	Try	
		...
		Dim HeaderReport As DataTable = getProp.PermissionName(1023,Session("LangID"),objCnn)
		
		If HeaderReport.Rows.Count > 0 Then
			HeaderText.InnerHtml = HeaderReport.Rows(0)("PermissionItemName")
		Else
			HeaderText.InnerHtml = "Transfer Document Reports"
		End If
		...
		rData("DocumentTypeGroupID") = "3"
		rData("GroupName") = "Materials"
		DocTypeGroup.Rows.Add(rData)
		
		'rData = DocTypeGroup.NewRow
		'rData("DocumentTypeGroupID") = "1000"
			...
			TestTime += "<br>" + DateTimeUtil.CurrentDateTime
				...
				For i = 0 To displayTable.Rows.Count - 1
				   ...
				   If UnitRatioVal = 1 Or displayTable.Rows(i)("SummaryAmount") = 0 Then
				   		outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + Format(displayTable.Rows(i)("SummaryAmount")/UnitRatioVal, "##,##0") + "</td>")    
				   Else
				   		outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" + Format(displayTable.Rows(i)("SummaryAmount")/UnitRatioVal, "##,##0.00") + "</td>")    
				   End If
