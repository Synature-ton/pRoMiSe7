...
<html>
<head>
<title>Refill Prepaid Reports</title>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("Report_FillPrepaid") Then
	...
	Try	
		...
		End If
			...
			HeaderText.InnerHtml = "Refill Prepaid Report"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Application.Lock()
		Dim dtTable As DataTable = getReport.RefillPrepaidReports(Radio_1.Checked, Radio_2.Checked, Request.Form("MonthYearDate_Month"), Request.Form("MonthYearDate_Year"), DateFromValue, DateToValue, Request.Form("ShopID"), objCnn)
		Application.UnLock()
