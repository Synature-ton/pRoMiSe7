...
<html>
<head>
<title>Sale Reports By SaleMode</title>
...
Dim PageID As Integer = 10
    ...
    Sub Page_Load()
        If User.Identity.IsAuthenticated And Session("ReportSaleMode") Then
            ...
            Try
                ...
                End If
                'Not In Customize Report
                bolAddVATPriceInProduct = False
                
                SubmitForm.Text = LangDefault.Rows(3)(LangText)
	
                LangText0.Text = LangData2.Rows(16)(LangText)
                ...
                If bolAddVATPriceInProduct = True Then
                    strTemp = POSBackOfficeReport.BackOfficeReport.GetLanguageText(LangData2, 17, LangText, "Sub Total Before VAT")
                    HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" & strTemp & "</td>"
                    strTemp = POSBackOfficeReport.BackOfficeReport.GetLanguageText(LangData2, 18, LangText, "VAT")
                    HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" & strTemp & "</td>"
                End If
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If FoundError = False Then
            ...
            Dim dtTable As DataTable = getReport.SaleReportBySaleMode(outputString, grandTotal, VATTotal, GraphData, PaymentResult, PayByCreditMoney, StartDate, EndDate, _
                                                        Request.Form("ShopID"), 0, 0, Session("StaffRole"), objCnn)

            getReport.GenOutputSaleByDept(GraphData, False, bolAddVATPriceInProduct, outputString, grandTotal, VATTotal, False, _
                                        GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, dtTable, _
                                        PaymentResult, PayByCreditMoney, Request.Form("ShopID"), StartDate, EndDate, Session("LangID"), LangPath, objCnn)
            ...
            If Request.Form("ShopID") = 0 Then
                ShopDisplay = LangDefault.Rows(23)(LangText) ' "All Shops"
            Else
                ShopDisplay = SelShopName.Value
            End If
            ResultSearchText.InnerHtml = LangData2.Rows(15)(LangText) + " " + ShopDisplay + " (" + ReportDate + ")"
            ...
            If view.Count > 0 Then
                ...
                ConfigureColors(LangData2.Rows(15)(LangText) + " " + ShopDisplay + " (" + ReportDate + ")")
...
Sub ExportData(Source As Object, E As EventArgs)
	...
	Dim FileName As String = "SaleModeData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
