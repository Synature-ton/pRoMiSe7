<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Reports_CompareTransferDocument, App_Web_comparetransferdocument.aspx.dfa151d5" enableEventValidation="false" %>
            ...
            <table id="filter" style="width: 100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="TextLeft">
                             <div style="float: left;">
                                <asp:DropDownList ID="ddListDocType" runat="server">
                                </asp:DropDownList>
                            </div></td>
                        <td class="TextRight">
                     ...
                     <tr>
                        ...
                        <td class="TextLeft">
                            <div style="float: left;">
                                <asp:DropDownList ID="DdlProductlevel1" runat="server">
                                </asp:DropDownList>
                            </div>
                        </td>
                        <td class="TextRight">
                    ...
                    <tr>
                        ...
                        <td class="TextLeft" >
                            <div style="float: left;">
                                <asp:DropDownList ID="DdlProductlevel2" runat="server">
                                </asp:DropDownList>
                            </div>
                        </td>
                        <td class="TextRight">
                        ...
                        <td>
                         <div style="float: left;">
                                ...
                                <span class="txt_label" style="padding-left: 10px; padding-right: 10px"><asp:Label
                                    ID="Label5" runat="server" Text="Label"></asp:Label></span>
                            ...
                            <div style="float: left; padding-left: 20px; ">
                             <asp:UpdateProgress runat="server" ID="PageUpdateProgress" AssociatedUpdatePanelID="updatePanelOK">
                                                    <ProgressTemplate>
                                                        ...
                                                        <asp:Label ID="Label6" runat="server" Text="Please wait...."></asp:Label>
                                                    </ProgressTemplate>
                                                </asp:UpdateProgress>
                            </div>
                        </td>
