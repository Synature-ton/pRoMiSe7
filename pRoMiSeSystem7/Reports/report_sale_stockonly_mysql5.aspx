...
<html>
<head>
<title>Sale Stock Only Reports</title>
	...
	Try	
		...
		If (Radio_11.Checked = True AND (Radio_1.Checked = True Or Radio_2.Checked = True Or Radio_4.Checked = True)) Or Radio_13.Checked = True Or (Request.Form("ShopID") = 0 And Radio_12.Checked = False) Or (Radio_11.Checked = True AND Radio_3.Checked = True And ExpandReceipt.Checked = False) Then
			If Radio_11.Checked = True AND Radio_3.Checked = True And ExpandReceipt.Checked = False And Request.Form("ShopID") > 0 Then
				...
				HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Document Name</td>"
				HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Input By</td>"
			...
			End If
			HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>SubTotal</td>"
		...
		HeaderText.InnerHtml = "Sale Stock Only Report"
		...
		Dim getOnlyStock As DataTable = getReport.PayTypeOnlyStockData(0,0,Session("LangID"),objCnn)
		If getOnlyStock.Rows.Count = 0 Then 
			ShowPage.Visible = False
			errorMsg.InnerHtml = "There is no stock only data in database"
		Else
			outputString = "<select name=""PayTypeID"" class=""text"" style=""width=200px"">"
			If getOnlyStock.Rows.Count > 1 Then
				If Not Page.IsPostBack Then 
					FormSelected = "selected"
					PayTypeName.Value = "All Types"
				...
				Else
					FormSelected = ""
				End If
				outputString += "<option value=""" & "0" & """ " & FormSelected & ">" & "--- All Types ---"
			End If
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		If Request.Form("ShopID") > 0 Or (Request.Form("ShopID")=0 AND R12 = True) Then
			...
			ResultText.InnerHtml = getReport.SaleStockOnlyReports(PayTypeList,outputString, grandTotal, VATTotal, GraphData, False,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, Request.Form("GroupByParam"), StartDate, EndDate, Request.Form("ShopID"),0,0,False,ExpReceipt, DGraph, Request.Form("PayTypeID").ToString, objCnn)
		...
		End If
		ResultSearchText.InnerHtml = "Stock Only " + PayTypeName.Value + " Report of " + ShopDisplay + " (" + ReportDate + ")"
		'Application.UnLock()
