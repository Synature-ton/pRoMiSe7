	...
	If User.Identity.IsAuthenticated Then
	  ...
	  If NOT Request.QueryString("MaterialID") AND IsNumeric(Request.QueryString("MaterialID")) Then
		...
		Try
        	...
        	dtTable = getInfo.MaterialDocument(Request.QueryString("ProductLevelID"),Request.QueryString("DocumentTypeGroupID"),MaterialID.Value,Request.QueryString("SelMonth"),Request.QueryString("SelYear"), Session("LangID"), objCnn)	
				...
				For i = 0 To dtTable.Rows.Count - 1
					...
					If dtTable.Rows(i)("calculatestandardprofitloss") = 1 Then
						...
						Else
							...
							Else
								outputString += "<td align=""right"" class=""" + SelectedText + """>" & Format(dtTable.Rows(i)("MovementInStock")*dtTable.Rows(i)("ProductNetPrice")/dtTable.Rows(i)("UnitSmallAmount"),"##,##0.0000") & "</td>"
							End If
						End If
					...
					If headerTD12.Visible = True Then
						If dtTable.Rows(i)("calculatestandardprofitloss") = 1 Then
							...
							If (dtTable.Rows(i)("ProductNetPrice")*1000)/dtTable.Rows(i)("UnitSmallAmount") < 1 And (dtTable.Rows(i)("ProductNetPrice")*1000)/dtTable.Rows(i)("UnitSmallAmount") <> 0 Then
								outputString += "<td align=""right"" class=""" + SelectedText + """>" & Format(dtTable.Rows(i)("MovementInStock")*dtTable.Rows(i)("ProductNetPrice")/dtTable.Rows(i)("UnitSmallAmount"),"E4") & "</td>"
							Else
								outputString += "<td align=""right"" class=""" + SelectedText + """>" & Format(dtTable.Rows(i)("MovementInStock")*dtTable.Rows(i)("ProductNetPrice")*UnitRatioVal/dtTable.Rows(i)("UnitSmallAmount"),"##,##0.0000") & "</td>"
							End If
						Else
