...
Dim InvC As CultureInfo = CultureInfo.InvariantCulture
    ...
    Sub Page_Load()
        If User.Identity.IsAuthenticated And Session("Report_Sale_New") Then
            ...
            Try
                ...
                HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" & BackOfficeReport.GetLanguageText(saleByProductLangData, 21, LangText, "Product Group") & "</td>"
                ...
                HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" & BackOfficeReport.GetLanguageText(saleByProductLangData, 22, LangText, "Sale Date") & "</td>"
                ...
                chkDisplayDeleteProduct.Checked = False
                chkDisplayDeleteProduct.Visible = False
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If FoundError = False Then
            ...
            If bolAllShop = False Then
                ResultText.InnerHtml = reports.SaleByProduct_New_Noodle(objCnn, GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, Session("LangID"), _
    ...
    Sub ShowProductGroupData()
        ...
        dtData = ReportShareSQL.ListProductGroupByShop(objDB, objCnn, ShopInfo.SelectedItem.Value, chkDisplayDeleteProduct.Checked)
