...
<td valign="top" >
		<table>
            <tr>
                ...
                <Table style="height: 144px; width: 600px">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><div id="pnlProductDept" style="border-width:1px;border-style:solid;height:120px;width:280px;overflow:auto" >
                            <asp:CheckBoxList ID="chkbProductDept" runat="server" Height="25px" Width="261px" ></asp:CheckBoxList>
                       </div></td>
                    </tr>
                </Table>
            </tr>
...
Dim InvC As CultureInfo = CultureInfo.InvariantCulture
    ...
    Sub Page_Load()
        If User.Identity.IsAuthenticated And Session("New_Sale_Report_by_Group") Then
            ...
            Try
                ...
                HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" & BackOfficeReport.GetLanguageText(saleByProductLangData, 20, LangText, "Product Dept") & "</td>"
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If FoundError = False Then
            ...
            If SelProductGroupIDList.Value = "" And SelProductDeptIDList.Value = "" Then
                errorMsg.InnerHtml = "Please select product dept to view report."
            ...
            End If
            ResultText.InnerHtml = reports.SaleByProductGroupDept_New(objCnn, GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, Session("LangID"), _
                                     StartDate, EndDate, SelShopIDList.Value, SelProductGroupIDList.Value, SelProductDeptIDList.Value, LangPath)
        End If
    ...
    Sub ExportData(Source As Object, E As EventArgs)
        ...
        Dim FileName As String = "SaleByProductGroupData_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
