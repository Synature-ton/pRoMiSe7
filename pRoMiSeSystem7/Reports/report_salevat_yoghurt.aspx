...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		'Application.Lock()
            Dim dtTable As DataTable = getReport.SaleVATReports(StartDate, EndDate, Request.Form("ShopID"), Session("LangID"), ViewOption, Session("StaffRole"), True, objCnn)
		...
		End If
            ...
            For i = 0 To dtTable.Rows.Count - 1
                ...
                If (i <> dtTable.Rows.Count - 1) And (Request.Form("ShopID") <> 0) Then
                    If (dtTable.Rows(i)("ComputerID") <> dtTable.Rows(i + 1)("ComputerID")) And (dtTable.Rows(i)("ShopID") = dtTable.Rows(i + 1)("ShopID")) Then
                        myDataRow = myDataTable.NewRow()
...
Private Sub Results_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) 
	...
	Dim LangText As String = "lang" + Session("LangID").ToString
        If e.Item.ItemType = ListItemType.Header Then
            ...
            If Request.Form("ShopID") = 0 Then
                'Shop Name
                If LangData2.Rows.Count > 29 Then
                    e.Item.Cells(1).Text = LangData2.Rows(29)("TextParamValue")
                Else
                    e.Item.Cells(1).Text = "Shop Name"
                End If
            Else
                'Date
