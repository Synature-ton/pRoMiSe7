...
<html>
<head>
<title>Online Tax Reports</title>
...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="Sales Report By Angkasa Pura" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("OnlineAP") Then
	...
	Try	
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Transaction ID</td>"
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Computer ID" + "</td>"	
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Receipt Number" + "</td>"		
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Transaction Time" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Menu Item" + "</td>"
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Menu Code" + "</td>"
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Transaction Amount" + "</td>"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		ResultText.InnerHtml = OnlineTaxReport(dtTable, StartDate, EndDate, Request.Form("ShopID"), LangPath, Session("StaffRole"), objCnn)
		...
		End If
		ResultSearchText.InnerHtml = "Online AP Report" + " " + ShopDisplay + " (" + ReportDate + ")"
		'Application.UnLock()
...
Sub ExportData(Source As Object, E As EventArgs)
	...
	FileName = "OnlineAP_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
...
End Sub	
 ...
 Public Function OnlineTaxReport(ByRef dtTable As DataTable, ByVal StartDate As String, ByVal EndDate As String, ByVal ShopID As String, ByVal LangPath As String, ByVal StaffRoleID As Integer, ByVal objCnn As MySqlConnection) As String
        ...
        sqlStatement = "SELECT * FROM onlineap a where 0=0 " + AdditionalQuery + " order by ShopCode,PaidTime,InvoiceNumber"
		dtTable = objDb.List(sqlStatement, objCnn)
		
		Dim ColSpan As Integer = 4
		Dim outputString As StringBuilder = New StringBuilder
		Dim TotalAmount As Double = 0
		Dim TotalQty as Double = 0
		For i = 0 To dtTable.Rows.Count - 1
			outputString = outputString.Append("<tr>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & dtTable.Rows(i)("TransactionID").ToString & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & dtTable.Rows(i)("ShopCode").ToString & "</td>")
			outputString = outputString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("ShopName").ToString & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & dtTable.Rows(i)("ComputerID").ToString & "</td>")
			outputString = outputString.Append("<td align=""center"" class=""" + TextClass + """>" & dtTable.Rows(i)("InvoiceNumber") & "</td>")
			outputString = outputString.Append("<td align=""center"" class=""" + TextClass + """>" & dtTable.Rows(i)("TransactionTime") & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & dtTable.Rows(i)("ItemName").ToString & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & dtTable.Rows(i)("ItemCode").ToString & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & CDbl(dtTable.Rows(i)("Quantity")).ToString(FormatObject.QtyFormat, ci) & "</td>")
			outputString = outputString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("Unit").ToString & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & CDbl(dtTable.Rows(i)("PricePerUnit")).ToString(FormatObject.CurrencyFormat, ci) & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & CDbl(dtTable.Rows(i)("TransactionAmount")).ToString(FormatObject.CurrencyFormat, ci) & "</td>")
			outputString = outputString.Append("</tr>")
			TotalQty += dtTable.Rows(i)("Quantity")
			TotalAmount += dtTable.Rows(i)("TransactionAmount")
		Next
		If dtTable.Rows.Count > 0 Then
			outputString = outputString.Append("<tr>")
			outputString = outputString.Append("<td align=""right"" colspan=""8"" class=""" + TextClass + """>" & "Sub Total" & "</td>")
			...
			outputString = outputString.Append("<td align=""left"" class=""" + TextClass + """>" & "" & "</td>")
			outputString = outputString.Append("<td align=""right"" class=""" + TextClass + """>" & CDbl(TotalAmount).ToString(FormatObject.CurrencyFormat, ci) & "</td>")
			outputString = outputString.Append("</tr>")
		End If
