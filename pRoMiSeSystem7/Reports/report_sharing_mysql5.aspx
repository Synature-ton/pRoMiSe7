...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("Report_Sharing") Then
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		getReport.SharingSaleReports(dtTable,grandTotal,GraphData, StartDate, EndDate, ShopInfo.SelectedItem.Value,GroupInfo.SelectedItem.Value,DeptInfo.SelectedItem.Value, DisplayGraph.Checked, Session("LangID"),"",0, objCnn)
