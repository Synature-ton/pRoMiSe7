...
<html>
<head>
<title>Redeem/Reward Detail Report</title>
...
Sub Page_Load()
	...
	Try	
		...
		LangText0.Text = "Redeem/Reward Point Detail"'LangData.Rows(0)(LangText)
		...
		If NOT Request.QueryString("ShopID") is Nothing AND NOT Request.QueryString("PointTypeGroupID") is Nothing Then
			If IsNumeric(Request.QueryString("ShopID")) Then
				ShowHeader.Visible = True
				ShowPrint.Visible = True
				If Request.QueryString("PointTypeGroupID") = 1 Then
					ReportText = "Reward"
				Else
					ReportText = "Redeem"
				End If
				ResultSearchText.InnerHtml = ReportText + " Detail Report for" + " " + Request.QueryString("ShopName") + " (" + Request.QueryString("ReportDate") + ")"
				Dim dtTable As DataTable = getReport.RedeemRewardDetailReport(Request.QueryString("PointTypeGroupID"),Request.QueryString("ShopID"),Session("LangID"),Request.QueryString("StartDate"),Request.QueryString("EndDate"),objCnn)
				...
				HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Receipt Date" + "</td>"
				...
				HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Total Point" + "</td>"
				HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Description" + "</td>"
				HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Submit Datetime" + "</td>"
				HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "By" + "</td>"
				...
				For i = 0 To dtTable.Rows.Count - 1
					...
					End If
					If Request.QueryString("PointTypeGroupID") = 1 Then
						Receipt = "<a class=""smallText"" href=""JavaScript: newWindow = window.open( 'BillDetails.aspx?ComputerID=" + dtTable.Rows(i)("ComputerID").ToString + "&ShopID=" + dtTable.Rows(i)("ShopID").ToString + "&TransactionID=" + dtTable.Rows(i)("TransactionID").ToString + "', '', 'width=750,height=600,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()"">" + dtTable.Rows(i)("ReceiptNumber") + "</a>"
					Else
						Receipt = dtTable.Rows(i)("ReceiptNumber")
					End If
					outString = outString.Append("<tr bgColor=""" + BgColor + """>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & (i+1).ToString & "</td>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("ShopCode") & "</td>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("ShopName") & "</td>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & Receipt & "</td>")
					outString = outString.Append("<td align=""center"" class=""" + TextClass + """>" & CDate(dtTable.Rows(i)("PointDate")).ToString(FormatObject.DateFormat, ci) & "</td>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("MemberCode") & "</td>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("MemberFirstName") & " " & dtTable.Rows(i)("MemberLastName") & "</td>")
					outString = outString.Append("<td align=""right"" class=""" + TextClass + """>" & CDbl(dtTable.Rows(i)("TotalPoint")).ToString(FormatObject.CurrencyFormat, ci) & "</td>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("Description") & "</td>")
					outString = outString.Append("<td align=""center"" class=""" + TextClass + """>" & CDate(dtTable.Rows(i)("HistoryDateTime")).ToString(FormatObject.DateFormat, ci) & " " & CDate(dtTable.Rows(i)("HistoryDateTime")).ToString(FormatObject.TimeFormat, ci) & "</td>")
					outString = outString.Append("<td align=""left"" class=""" + TextClass + """>" & dtTable.Rows(i)("StaffFirstName") & " " & dtTable.Rows(i)("StaffLastName") & "</td>")
					outString = outString.Append("</tr>")
					TotalPoint += dtTable.Rows(i)("TotalPoint")
				Next
				
				outString = outString.Append("<tr bgColor=""" + "#dcdcdc" + """>")
				outString = outString.Append("<td align=""right"" colspan=""7"" class=""" + TextClass + """>" & "Summary" & "</td>")
				outString = outString.Append("<td align=""right"" class=""" + TextClass + """>" & CDbl(TotalPoint).ToString(FormatObject.CurrencyFormat, ci) & "</td>")
				outString = outString.Append("<td align=""right"" colspan=""3"" class=""" + TextClass + """>" & "" & "</td>")
				outString = outString.Append("</tr>")
