<%@ page language="VB" autoeventwireup="false" inherits="Reports_Report_ProductQtyByOrderStaff, App_Web_report_productqtybyorderstaff.aspx.dfa151d5" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Product Qty By Order Staff Report</title>
        ...
        <table bgcolor="White" cellpadding="0" cellspacing="0">
            <tr style="background-color: #EEEEEE">
                ...
                <td colspan="2" style="background-image: url('../images/headerbg2000.jpg');">
                    <div class="noprint">
                        <asp:Label ID="lblHeader" runat="server" Text="Product Qty By Order Staff Report" CssClass="headerText"></asp:Label>
                    </div>
                </td>
