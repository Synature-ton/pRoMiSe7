...
<html>
<head>
<title>Sale Reports By Table</title>
...
<tr id="ShowShop" runat="server">
	...
	<table>
		...
		<tr id="InputError" visible="false" runat="server">
			<td></td>
			<td class="errorText">Table must be filled and must be numeric number</td>
		</tr>
		<tr>
			<td class="text">Table</td>
			<td colspan="3" class="text"><asp:TextBox ID="FromTable" CssClass="text" Width="70" runat="server" /> to <asp:TextBox ID="ToTable" CssClass="text" Width="70" runat="server" /></td>
		</tr>
...
Sub Page_Load()
	...
	If User.Identity.IsAuthenticated  AND Session("Sale_Report_ByTable") Then
	...
	Try	
		...
		LangText0.Text = "Sale Report By Table"
...
End Sub
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If Not IsNumeric(FromTable.Text) Or Not IsNumeric(ToTable.Text) Then
        ...
        If FoundError = False Then
            ...
            Else
                ViewOption = 0
            End If
            Dim TableHeaderString As String
            Dim TableNameString As String = "DummyReportByTable_" + Session.SessionID
            Dim ZoneTable, GroupTable As DataTable
            'Application.Lock()
            Dim dtTable As DataTable = getReport.SaleReportByTable(outputString, ZoneTable, GroupTable, TableNameString, StartDate, EndDate, Request.Form("ShopID"), FromTable.Text, ToTable.Text, objCnn)
		
            getReport.GenOutputSaleByTable(outputString, TableHeaderString, TableNameString, ZoneTable, GroupTable, GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, Session("LangID"), objCnn)
            ...
            ResultSearchText.InnerHtml = "Sale Report By Table of " + ShopDisplay + " (" + ReportDate + ")"
            'Application.UnLock()
		
            TableHeaderText.InnerHtml = TableHeaderString
    ...
    Sub ExportData(Source As Object, E As EventArgs)
        ...
        Dim FileName As String = "SaleByTable_" & DateTime.Now.ToString("yyyyMMdd_HHmmss", InvC) & ".xls"
