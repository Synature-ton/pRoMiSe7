...
Sub Page_Load()
	...
	Try	
		...
		HeaderText.InnerHtml = "Promotion Discount By Product Group Report"
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Promotion Name</td>"
		...
		If Not Page.IsPostBack Then
			...
			If IsNumeric(Request.QueryString("ShopID")) Then
				...
				'Application.UnLock()
				GenResults(PromotionData,Request.QueryString("ShopID"),ReportDate)
			End If
		End If
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Dim SummaryPromotion As New DataTable()
		'Application.Lock()
		Dim Result As String = getReport.PromotionDiscountReport(SummaryPromotion,2,dtTable,PromotionData,StartDate, EndDate, Request.Form("ShopID"), Session("LangID"), PromotionID, objCnn)
		'Application.UnLock()
		
		GenResults(PromotionData,Request.Form("ShopID"),ReportDate) 
...
Public Function GenResults(ByVal PromotionData As DataTable, ByVal ShopID As Integer, ByVal ReportDate As String) As String
		...
		End If
		ResultSearchText.InnerHtml = ReportHeader + "Discount Type Summary Report (" + ReportDate + ")"
		...
		For i = 0 To PromotionData.Rows.Count - 1
			If PromotionData.Rows(i)("ProductGroupCode") <> DummyProductGroupCode Then
				If i > 0 Then
					...
					outputString += "<td colspan=""2"" align=""right"" class=""smallText"">Summary</td>"
				...
				If PromotionData.Rows(i)("ProductGroupCode") <> "" Then
					outputString += "<td colspan=""" + ColSpan + """ align=""left"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Discount: " + PromotionData.Rows(i)("ProductGroupName") + "</td>"
				Else
					outputString += "<td colspan=""" + ColSpan + """ align=""left"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>NONE</td>"
				End If
				outputString += "</tr>"
				countPromo += 1
			End If
		...
		If countPromo > 1 Then
			...
			outputString += "<tr bgColor=""" + GlobalParam.GrayBGColor + """>"
			outputString += "<td colspan=""2"" align=""right"" class=""smallText"">Grand Total</td>"
