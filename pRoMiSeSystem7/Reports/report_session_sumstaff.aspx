...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="Session Staff Report" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
        ...
        If User.Identity.IsAuthenticated And Session("Report_Session") Then
            ...
            Try
                ...
                If IsNumeric(Request.QueryString("ShopID")) And IsNumeric(Request.QueryString("StaffID")) And Trim(Request.QueryString("StartDate")) <> "" And Trim(Request.QueryString("EndDate")) <> "" Then
                    ...
                    ResultText.InnerHtml = getReport.SessionStaffReports(dtTable, PaymentResult, GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, Session("LangID"), 0, Request.QueryString("StartDate"), Request.QueryString("EndDate"), Request.QueryString("ShopID"), Request.QueryString("StaffID"), 0, objCnn)
