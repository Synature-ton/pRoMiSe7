...
Sub Page_Load()
	...
	Try	
		...
		If MySQL5Report = True Then
			Response.Redirect("report_bydept2_mysql5.aspx")
		End If
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Application.Lock()
		Dim dtTable As DataTable = getReport2.SaleReportByDept(ShowGroup.Checked,outputString, grandTotal, VATTotal, GraphData, PaymentResult, PayByCreditMoney, StartDate, EndDate, Request.Form("ShopID"),0,0, objCnn)

		getReport.GenOutputSaleByDept(outputString,grandTotal,VATTotal,False,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,dtTable,PaymentResult,PayByCreditMoney,Request.Form("ShopID"),StartDate,EndDate,objCnn)
