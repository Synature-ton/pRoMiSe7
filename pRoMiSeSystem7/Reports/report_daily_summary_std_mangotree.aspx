...
End Sub	
    ...
    Public Function DailyReport(ByVal ShowGroup As Boolean, ByRef ResultString As String, ByRef ResultString2 As String, ByRef ResultString3 As String, ByVal StartDate As String, ByVal EndDate As String, ByVal ShopID As Integer, ByVal TransactionID As Integer, ByVal ComputerID As Integer, ByVal OrderBy As String, ByVal AdminBGColor As String, ByVal LangID As Integer, ByVal BeginDay As String, ByVal NoDay As Integer, ByVal objCnn As MySqlConnection) As DataTable
        ...
        sqlStatement = "select SaleMode,SaleModeName,ProductGroupCode,ProductGroupName,GroupOrdering,SUM(Amount) As TotalQty, SUM(TotalRetailPrice) As TotalRetailPrice, SUM(SalePrice) As SalePrice from summary_productreport a where TransactionStatusID=2 AND ProductSetType NOT IN (-1,-3,14,16) AND a.DocType=8 " + AdditionalQuery + " group by SaleMode,SaleModeName,ProductGroupCode,ProductGroupName,GroupOrdering order by SaleMode,GroupOrdering"
        ...
        For i = 0 To PaymentData.Rows.Count - 1
			...
			End If
			If PaymentData.Rows(i)("PayTypeID") = 2 Then
				subTotalQty += PaymentData.Rows(i)("TotalQty")
				subTotal += PaymentData.Rows(i)("TotalPay")
				If i <= PaymentData.Rows.Count - 1 Then
				If i = PaymentData.Rows.Count - 1 Then
                    outputString2 = outputString2.Append("<tr bgColor=""#ebebeb"">")
                    outputString2 = outputString2.Append("<td align=""left"" class=""" + TextClass + """>" + PaymentData.Rows(i)("PayTypeName") + "</td>")
		...
		If grandTotalDiscount <> 0 Then
			outputString2 = outputString2.Append("<tr bgColor=""#ebebeb"">")
			outputString2 = outputString2.Append("<td align=""right"" class=""" + TextClass + """><a class=""smallText"" href=""JavaScript: newWindow = window.open( 'report_promotions.aspx?op=1&viewreporttype=" + "2" + "&PromotionID=-1" + "&ShopID=" + ShopID.ToString + "&fromdate=" + Replace(StartDate, "'", "\'") + "&todate=" + Replace(EndDate, "'", "\'") + "', '', 'width=800,height=600,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()"">" + "Total Discount" + "</a></td>")
		...
		For i = 0 To SessionData.Rows.Count - 1
			...
			outputString3 = outputString3.Append("</tr>")
			outputString3 = outputString3.Append("<tr>")
			outputString3 = outputString3.Append("<td align=""left"" class=""" + TextClass + """>" + "Cash Balance" + "</td>")
			outputString3 = outputString3.Append("<td align=""right"" class=""" + TextClass + """>" + Format(TotalCash, "##,##0.00") + "</td>")
			outputString3 = outputString3.Append("</tr>")
		Next
