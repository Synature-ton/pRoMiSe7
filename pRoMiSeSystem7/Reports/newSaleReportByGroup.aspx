<%@ page language="C#" autoeventwireup="true" inherits="Reports_newSaleReportBuDept, App_Web_newsalereportbygroup.aspx.dfa151d5" enableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Sale report by Product Group</title>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                ...
                                <div style=" float:left; padding:3px;">
                                    ...
                                    [<a href="#" onclick="chkAll('chkListCategory');">Select All</a>]
                                    [<a href="#" onclick="clsAll('chkListCategory');">Clear All</a>]
                                ...
                                <%--<div style=" float:left; padding:3px;">
                                    ...
                                    <asp:Panel ID="panelProduct" runat="server" Width="300px" Height="120px" ScrollBars="Auto" BorderWidth="1px">
                                        <asp:CheckBoxList ID="chkListProduct" runat="server" AutoPostBack="True">
                                        </asp:CheckBoxList>
                                    </asp:Panel>
                                </div>--%>
                            </td>
