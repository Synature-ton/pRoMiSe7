...
<%@Import Namespace="MajorReports.pRoMiSeMajorReport" %>
...
Dim MajorReport As New ReportModule()
		
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("Report_SaleByGroup2") Then
	...
	Try	
		...
		HeaderText.InnerHtml = "Check Summary Report 2"
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Application.Lock()
		Dim dtTable As DataTable = MajorReport.SaleReportByGroup2(ColumnData,PayTypeList,PayTypeData,ViewOption, StartDate, EndDate, Request.Form("ShopID"), 0, 0, Session("LangID"), objCnn)
		ResultSearchText.InnerHtml = "Check Summary Report 2 of " + SelShopName.Value + " (" + ReportDate + ")"
		Application.UnLock()
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>Total Amount</td>"
