...
<span id="startTable" runat="server"></span>
	...
	<span id="ExemptVATText" runat="server"></span>
	<span id="TableHeaderText2" runat="server"></span>
...
Dim PageID As Integer = 6
        ...
        If User.Identity.IsAuthenticated And Session("Report_Sale_New") Then
            ...
            Try
                ...
                If (Radio_11.Checked = True And (Radio_1.Checked = True Or Radio_2.Checked = True Or Radio_4.Checked = True)) Or Radio_13.Checked = True Or (Request.Form("ShopID") = 0 And Radio_12.Checked = False) Or (Radio_11.Checked = True And Radio_3.Checked = True And ExpandReceipt.Checked = False) Then
                    ...
                    'After this is ExemptVAT/ and HeaderString2
                    HeaderString2 += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + LangData2.Rows(26)(LangText) + "</td>"
                    If Request.Form("ShopID") >= 0 Then
                        If DisplayVATType = "E" Then
                            HeaderString2 += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + LangData2.Rows(27)(LangText) + "</td>"
                            HeaderString2 += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + LangData2.Rows(28)(LangText) + "</td>"
                        End If
                    End If
                    If Request.Form("ShopID") = 0 Then
                        'HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """></td>"
                    End If
                    HeaderString2 += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + LangData2.Rows(29)(LangText) + "</td>"
                    HeaderString2 += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + LangData2.Rows(30)(LangText) + "</td>"
                ...
                TableHeaderText2.InnerHtml = HeaderString2
    ...
    Sub DoSearch(Source As Object, E As EventArgs)
        ...
        If FoundError = False Then
            ...
            Dim additionalColumn() As String
            Dim LangPath As String = Util.GetLangPath(Request.PhysicalApplicationPath)
			
            ReDim additionalColumn(-1)
            If Request.Form("ShopID") >= 0 Or (Request.Form("ShopID") = 0 And R12 = True) Then
                ResultText.InnerHtml = getReport.SaleReports(PayTypeList, outputString, grandTotal, VATTotal, GraphData, additionalColumn, _
                                              True, GlobalParam.GrayBGColor, GlobalParam.AdminBGColor, Session("LangID"), ViewOption, R11, R12, R13, _
                                              Request.Form("GroupByParam"), StartDate, EndDate, Request.Form("ReportProductOrdering"), "", "", "", _
            ...
            End If
            If additionalColumn.Length >= 1 Then
                If additionalColumn(0) <> "" Then
                    ExemptVATText.InnerHtml = "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" & additionalColumn(0) & "</td>"
                End If
            End If
            ...
            Session("ReportResult") = "<table><tr><td align=""center"">" & ResultSearchText.InnerHtml & "</td></tr><tr><td align=""right"">" & CreateReportDate.Text & "</td></tr><tr><td>" & _
                            startTable.InnerHtml & "<tr>" & TableHeaderText.InnerHtml & ExemptVATText.InnerHtml & TableHeaderText2.InnerHtml & ExtraHeader.InnerHtml & _
                            "</tr>" & ResultText.InnerHtml & "</td></tr></table>"
