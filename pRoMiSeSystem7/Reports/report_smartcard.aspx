...
Sub Page_Load()
	If User.Identity.IsAuthenticated AND Session("Report_Smartcard") Then
		...
		Try
			...
			SectionText.InnerHtml = "Smart Card Information"
...
Public Function GenResult(ByVal MemberGroupID As String, ByVal MemberCode As String, ByVal MemberFirstName As String, ByVal MemberLastName As String, ByVal MemberTelephone As String, ByVal MemberMobile As String, ByVal objCnn As MySqlConnection) As String
	...
	dtTable = getReport.SearchSmartCardMember(MemberGroupID,MemberCode,MemberFirstName,MemberLastName,MemberTelephone,MemberMobile, "", objCnn)
	...
	For i = 0 to dtTable.Rows.Count - 1
		...
		If Not IsDBNull(dtTable.Rows(i)("RemainingAmount")) Then
			...
			outputString += "<td class=""text"" align=""right""><a href=""JavaScript: newWindow = window.open( 'SmartCardDetails.aspx?CardID=" + dtTable.Rows(i)("CardID").ToString + "&ProductLevelID=" + dtTable.Rows(i)("ProductLevelID").ToString + "&MemberName=" + dtTable.Rows(i)("MemberFullName") + "', '', 'width=700,height=700,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()"">" & dtTable.Rows(i)("RemainingAmount") & "</a></td>"
		Else
			outputString += "<td class=""text"" align=""right"">-</td>"
		End If
