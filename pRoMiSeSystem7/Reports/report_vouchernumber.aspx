...
<html>
<head>
<title>3rd Coupon/Voucher Reports</title>
...
<tr bgcolor="eeeeee">
	...
	<td colspan="2" background="../images/headerbg2000.jpg">
		<div class="noprint"><table width="100%"><tr><td align="left" width="70%"><b class="headerText"><asp:Label ID="LangText0" Text="Coupon/Voucher Remark Report" runat="server" /></b></td><td align="right"><asp:Label ID="LangList" runat="server" /></td></tr></table></div>
	</td>
...
Sub Page_Load()
	If User.Identity.IsAuthenticated  AND Session("VoucherNumber") Then
	...
	Try	
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Sale Date" + "</td>"
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Coupon/Voucher" + "</td>"
		...
		Dim ShopData As DataTable = getInfo.GetProductLevelAccess(-999,Session("StaffRole"),objCnn)'getInfo.GetAllShopData(objCnn)'getInfo.GetProductLevelAccess(-999,Session("StaffRole"),objCnn)
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		'Application.Lock()
		Dim Result As String = getReport.CouponRemarkReport(dtTable,StartDate, EndDate, Request.Form("ShopID"), Session("LangID"), objCnn)
		'Application.UnLock()
		...
		For i = 0 To dtTable.Rows.Count - 1
            ...
            outputString = outputString.Append("<td align=""left"" class=""smallText"">" + dtTable.Rows(i)("ShopName") + "</td>")
			outputString = outputString.Append("<td align=""left"" class=""smallText"">" + "<a class=""smallText"" href=""JavaScript: newWindow = window.open( 'BillDetails.aspx?ComputerID=" + dtTable.Rows(i)("ComputerID").ToString + "&ShopID=" + dtTable.Rows(i)("ShopID").ToString + "&TransactionID=" + dtTable.Rows(i)("TransactionID").ToString + "', '', 'width=750,height=600,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()"">" & RText & "</a>" + "</td>")
			outputString = outputString.Append("<td align=""center"" class=""smallText"">" + DateTimeUtil.FormatDateTime(dtTable.Rows(i)("SaleDate"), "DateOnly",Session("LangID"), objCnn) + "</td>")
			outputString = outputString.Append("<td align=""center"" class=""smallText"">" + DateTimeUtil.FormatDateTime(dtTable.Rows(i)("PaidTime"), "DateAndTime",Session("LangID"), objCnn) + "</td>")
			outputString = outputString.Append("<td align=""left"" class=""smallText"">" + dtTable.Rows(i)("MemberFullName") + "</td>")
			outputString = outputString.Append("<td align=""right"" class=""smallText"">" + CDbl(dtTable.Rows(i)("ReceiptSalePrice")).ToString(FormatObject.CurrencyFormat, ci) + "</td>")
			If Not IsDBNull(dtTable.Rows(i)("ReferenceNo")) Then
				outputString = outputString.Append("<td align=""right"" class=""smallText"">" + dtTable.Rows(i)("ReferenceNo") + "</td>")
			Else
