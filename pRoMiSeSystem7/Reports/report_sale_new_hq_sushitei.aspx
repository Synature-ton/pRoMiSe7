...
Sub Page_Load()
	...
	Try	
		...
		'For SushiTei No Show By Salemode because it combine all sale mode into column
...
'			HeaderString += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + LangData2.Rows(37)(LangText) + "</td>"
		...
		If Radio_3.Checked = True AND (Radio_11.Checked = True) And ExpandReceipt.Checked = True AND Request.Form("ShopID") >= 0 Then
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		If Request.Form("ShopID") >= 0 Or (Request.Form("ShopID")=0 AND R12 = True) Then
			ResultText.InnerHtml = Reports.SaleReports(IncomeType,PayTypeList,outputString, grandTotal, VATTotal, GraphData, True,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, receiptSaleType, Request.Form("GroupByParam"), StartDate, EndDate,Request.Form("ReportProductOrdering"),"","","", Request.Form("ShopID"),0,0,True,ExpReceipt, DGraph, LangPath, SMode, Session("StaffRole"), objCnn)
		...
		If (R11 = True AND (R1 = True Or R2 = True Or R4 = True)) Or R13 = True Or (R11 = True AND R3 = True And ExpReceipt = False) Then
			...
			Next
			If IncomeType.Rows.Count > 0 Then
				AdditionalHeader += "<td align=""center"" class=""smallTdHeader"" bgcolor=""" + GlobalParam.AdminBGColor + """>" + "Subtotal + Other income" + "</td>"
			End If
