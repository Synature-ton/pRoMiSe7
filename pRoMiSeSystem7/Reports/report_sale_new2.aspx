...
Sub Page_Load()
	...
	Try	
		...
		If MySQL5Report = True Then
			Response.Redirect("report_sale_new2_mysql5.aspx")
		End If
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		If Request.Form("ShopID") > 0 Or (Request.Form("ShopID")=0 AND R12 = True) Then
			If R12 = True Then
				ResultText.InnerHtml = getReport2.SaleReports(PayTypeList,outputString, grandTotal, VATTotal, GraphData, True,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, Request.Form("GroupByParam"), StartDate, EndDate, Request.Form("ShopID"),0,0,True,ExpReceipt, DGraph,2, objCnn)
			Else
				SCData = getReport2.ServiceChargeSummary(GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Request.Form("ShopID"), StartDate, EndDate,objCnn)
				ResultText.InnerHtml = getReport.SaleReports(PayTypeList,outputString, grandTotal, VATTotal, GraphData, True,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, Request.Form("GroupByParam"), StartDate, EndDate,"","","","", Request.Form("ShopID"),0,0,True,ExpReceipt, DGraph, objCnn) + SCData
		...
		Else
			SCData = getReport2.ServiceChargeSummary(GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Request.Form("ShopID"), StartDate, EndDate,objCnn)
			ResultText.InnerHtml = getReport.SaleReportsAll(outputString, grandTotal, GraphData, True,GlobalParam.GrayBGColor,GlobalParam.AdminBGColor,Session("LangID"),ViewOption,R11, R12, R13, Request.Form("GroupByParam"), StartDate, EndDate, ShopIDList.Value,0,0,True,ExpReceipt, DGraph, objCnn) + SCData
