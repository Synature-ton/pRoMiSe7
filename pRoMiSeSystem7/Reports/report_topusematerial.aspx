...
<html>
<head>
<title>Top Use Material Reports</title>
...
<tr id="ShowDocGroup" runat="server">
	<td valign="top">
		<table>
			...
			<tr>
				<td><asp:textbox ID="Top" Width="100" Text="20" runat="server" /></td>
			</tr>
			<tr>
...
Sub DoSearch(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Dim dtTable As DataTable = TopMaterialReport(TotalSale,SaleDay,TableNameString,Request.Form("ShopID"),Top.Text, StartDate, EndDate, SelMonth, SelYear, Session("LangID"), "", objCnn)
		...
		HeaderString += "<td align=""center"" class=""smallTdHeader"" bgColor=""" + GlobalParam.AdminBGColor + """>" + "Price/Unit" + "</td>"
