<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RedeemAddProducts.aspx.vb" Inherits="RewardPointSetting.RedeemAddProducts" %>
                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td><a href="javascript:CheckAll(true)">Select&nbsp;All</a> | <a href="javascript:CheckAll(false)">Clear&nbsp;All</a> &nbsp;|&nbsp;
                                <asp:LinkButton ID="LbtnDeleteProd" runat="server" OnClientClick="if (!confirm('คุณต้องการลบสินค้าเข้าร่วมตามที่เลือกใช่หรือไม่?')) return false;"
