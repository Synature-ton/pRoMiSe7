<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RewardApplyMember.aspx.vb" Inherits="RewardPointSetting.RewardApplyMember" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>กำหนดกลุ่มสมาชิกเข้า</title>
       ...
       <table bgcolor="White" cellpadding="0" cellspacing="0">
            <tr style="background-color: #EEEEEE">
                ...
                <td colspan="2" style="background-image: url('../images/headerbg2000.jpg')">
                    <div>
                        <asp:Label ID="lblHeader" runat="server" Text="กำหนดกลุ่มสมาชิก" CssClass="headerText"></asp:Label>
                    </div>
                </td>
