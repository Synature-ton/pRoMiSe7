        ...
        If User.Identity.IsAuthenticated And ((Session("Promotion_Coupon") And Request.QueryString("type") = 4) Or (Session("Promotion_Voucher") And Request.QueryString("type") = 5)) Then
            ...
            Try
                ...
                If IsNumeric(Request.QueryString("VoucherTypeID")) Then
                    ...
                    ElseIf Request.QueryString("action") = "activation" And IsNumeric(Request.QueryString("ChangeActivateValue")) Then
                ...
                Dim dtTable, dtCVUse, dtCVTotalNumber As DataTable
                dtTable = getData.GetCVPromoInfo_New(Request.QueryString("type"), -1, -1, objCnn)
			
                dtCVTotalNumber = New DataTable
                dtCVUse = getData.ListCVTotalUseRecord(Request.QueryString("type"), dtCVTotalNumber, objCnn)
                ...
                For i = 0 To dtTable.Rows.Count - 1
                    ...
                    'Get Total Number/ Total Use
                    'getData.GetCVPromoRecord(totalNum, totalUsed, dtTable.Rows(i)("VoucherTypeID"), dtTable.Rows(i)("ReuseCoupon"), objCnn)
                    If dtCVTotalNumber.Rows.Count = 0 Then
                        totalNum = 0
                    Else
                        rResult = dtCVTotalNumber.Select("VoucherTypeID = " & dtTable.Rows(i)("VoucherTypeID"))
                        If rResult.Length = 0 Then
                            totalNum = 0
                        ElseIf IsDBNull(rResult(0)("TotalNumber")) Then
                            totalNum = 0
                        Else
                            totalNum = rResult(0)("TotalNumber")
                        End If
                    End If
                    If dtCVUse.Rows.Count = 0 Then
                        totalUsed = 0
                    Else
                        rResult = dtCVUse.Select("VoucherTypeID = " & dtTable.Rows(i)("VoucherTypeID"))
                        If rResult.Length = 0 Then
                            totalUsed = 0
                        ElseIf IsDBNull(rResult(0)("TotalNumberOfUse")) Then
                            totalUsed = 0
                        Else
                            totalUsed = rResult(0)("TotalNumberOfUse")
                        End If
                    End If
                    UsedString = "<a href=""promotion_voucher_details.aspx?VoucherTypeID=" + dtTable.Rows(i)("VoucherTypeID").ToString + "&Used=1&" + ExtraURL + """>" & _
                                        totalUsed.ToString + "</a>"
				
                    outputString += "<td align=""left"" class=""text"">" & dtTable.Rows(i)("VoucherTypeName") & "<br>(" & dtTable.Rows(i)("VoucherHeader") & ")</td>"
				
                    strTemp = "<a href=""promotion_voucher_details.aspx?VoucherTypeID=" + dtTable.Rows(i)("VoucherTypeID").ToString + "&" + ExtraURL + """>" & _
                                totalNum.ToString + "</a>" & "::" + UsedString
                
                    outputString += "<td align=""center"" class=""text"">" & strTemp & "</td>"
				
                    If headerTD8.Visible = True Then
                        Select Case dtTable.Rows(i)("ReuseCoupon")
                            Case 2, 4, 5
                                strTemp = "-"
                            Case Else
                                strTemp = "<a href=""promotion_voucher_add.aspx?VoucherTypeID=" & dtTable.Rows(i)("VoucherTypeID").ToString & "&" & ExtraURL & """>" & _
                                            textTable.Rows(49)("TextParamValue") & "</a>"
                        End Select
                        outputString += "<td align=""center"" class=""text"">" & strTemp & "</td>"
                    End If
				
                    If headerTD3.Visible = True Then
                        strTemp = "<a href=""promotion_voucher_edit.aspx?VoucherTypeID=" & dtTable.Rows(i)("VoucherTypeID").ToString & "&" & ExtraURL & """>" & _
                                        defaultTextTable.Rows(0)("TextParamValue") & "</a>"
                        outputString += "<td align=""center"" class=""text"">" & strTemp & "</td>"
                    End If
				
                    If headerTD4.Visible = True Then
                        strTemp = "<a href=""promotion_voucher.aspx?action=delete&VoucherTypeID=" & dtTable.Rows(i)("VoucherTypeID") & "&" & ExtraURL & _
                                   """ onClick=""javascript: return confirm('" & defaultTextTable.Rows(14)("TextParamValue") & " " & _
                                   Replace(dtTable.Rows(i)("VoucherTypeName"), "'", "\'") & " " & defaultTextTable.Rows(15)("TextParamValue") & "')"">" & _
                                   defaultTextTable.Rows(1)("TextParamValue") & "</a>"
                        outputString += "<td align=""center"" class=""text"">" & strTemp & "</td>"
                    End If
