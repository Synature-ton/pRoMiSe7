<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Promotion_NextReceiptHeaderFooter.aspx.vb" Inherits="POSPromotionSettings.Promotion_NextReceiptHeaderFooter" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Promotion NextReceipt</title>
    <style>
        /* -- General styles ------------------------------ */
        body
        {
...
<body>
    ...
    <div style="margin: 30px;">
        <form action="Promotion_NextReceiptHeaderFooter.aspx" method="post">
            
            <input type="hidden" name="LineType" value="0" />            
            <table style="width: 450px;">
                <tr>
                    <td colspan="2">
                        <h3>ส่วนหัวคูปองท้ายบิล</h3>
                    </td>
                </tr>
                <tr>
                    <td style="width: 110px;">เพิ่มข้อมูลส่วนหัวคูปอง</td>
                    <td>
                        <input type="text" name="TextInLine" value="" style="width: 200px; height: 25px;" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td><span id="HeaderPosition" runat="server"></span>&nbsp;<input type="submit" name="add" value="Add" style="width: 70px; height: 30px;" /><span id="h_pricegroupid" runat="server"></span> </td>
                </tr>

            </table>
        </form>
        <span id="HeaderLine" runat="server"></span>

        <form action="Promotion_NextReceiptHeaderFooter.aspx" method="post">
            <input type="hidden" name="LineType" value="1" />
            <table style="width: 450px;">
                <tr>
                    <td colspan="2">
                        <h3>ส่วนหางคูปองท้ายบิล</h3>
                    </td>
                </tr>
                <tr>
                    <td style="width: 110px;">เพิ่มข้อมูลส่วนหางคูปอง</td>
                    <td>
                        <input type="text" name="TextInLine" value="" style="width: 200px; height: 25px;" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td><span id="FooterPosition" runat="server"></span>&nbsp;<input type="submit" name="add" value="Add" style="width: 70px; height: 30px;" /><span id="f_pricegroupid" runat="server"></span></td>
                </tr>

            </table>
        </form>
         <span id="FooterLine" runat="server"></span>
    </div>
