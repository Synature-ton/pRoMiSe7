<%@ page language="VB" autoeventwireup="false" inherits="LinkOtherSystemReports_Report_BZB_SaleReport, App_Web_report_bzb_salereport.aspx.6ab36945" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Report BuzzeBee Sale Report</title>
        ...
        <table bgcolor="White" cellpadding="0" cellspacing="0">
            <tr style="background-color: #EEEEEE">
                ...
                <td colspan="2" style="background-image: url('../images/headerbg2000.jpg');">
                    <div class="noprint">
                        <asp:Label ID="lblHeader" runat="server" Text="Report BuzzeBee SaleReport" CssClass="headerText"></asp:Label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table style="width: 100%;" runat="server" id="tbCondition" class="noprint">
                        ...
                        <tr>
                            <td>  
                                <asp:CheckBox ID="chkDisplayByReceiptNo" runat="server" text="Display By Receipt No.">
                                </asp:CheckBox>
                            </td>
                            <td>
