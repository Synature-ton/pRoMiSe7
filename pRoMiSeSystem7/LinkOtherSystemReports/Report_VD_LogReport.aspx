<%@ page language="VB" autoeventwireup="false" inherits="LinkOtherSystemReports_Report_VD_LogReport, App_Web_report_vd_logreport.aspx.6ab36945" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Report Value Design Log</title>
        ...
        <table bgcolor="White" cellpadding="0" cellspacing="0">
            <tr style="background-color: #EEEEEE">
                ...
                <td colspan="2" style="background-image: url('../images/headerbg2000.jpg');">
                    <div class="noprint">
                        <asp:Label ID="lblHeader" runat="server" Text="Report Value Design Log" CssClass="headerText"></asp:Label>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table style="width: 100%;" runat="server" id="tbCondition" class="noprint">
                        ...
                        <tr>
                            <td>
                                <asp:DropDownList ID="cboFunctionType" runat="server">
                                </asp:DropDownList>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblSearchCardNo" runat="server" Text="Card No : " ></asp:Label>
                                <asp:TextBox ID="txtSearchCardNo" runat="server" Width="300px"  ></asp:TextBox>
                            </td>
                        </tr> 
                    </table>
                    <br />
