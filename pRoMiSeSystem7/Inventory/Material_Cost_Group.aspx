...
<html>
<head>
<title>Manage Payment Group</title>
<link href="../StyleSheet/admin.css" type="text/css" rel="stylesheet" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
</head>
<body>
<form id="mainForm" runat="server">
<input type="hidden" id="MaterialCostGroupID" runat="server" />
    ...
    Sub Page_Load()
        If User.Identity.IsAuthenticated Then
            ...
            Try
                ...
                dtTable = CostInfo.MaterialCostGroup(-1, objCnn)
                Dim i As Integer
                ...
                Text_SectionParam.InnerHtml = "Manage Material Cost Group"
                ...
                StartDate.EndYear = GlobalParam.EndYear
                ...
                EndDate.EndYear = GlobalParam.EndYear
                ...
                If Not Page.IsPostBack Then
                    MaterialCostGroupID.Value = -1
                    If IsNumeric(Request.QueryString("MaterialCostGroupID")) And Request.QueryString("Action") = "Edit" Then
                        MaterialCostGroupID.Value = Request.QueryString("MaterialCostGroupID")
                        getInfo = CostInfo.MaterialCostGroup(MaterialCostGroupID.Value, objCnn)
                    ...
                    ElseIf IsNumeric(Request.QueryString("MaterialCostGroupID")) And Request.QueryString("Action") = "Delete" Then
                        'getProp.DelPayTypeGroup(Request.QueryString("MaterialCostGroupID"),objCnn)
                        Response.Redirect("Material_Cost_Group.aspx")
                    End If
                Else
                ...
                For i = 0 To dtTable.Rows.Count - 1
                    ...
                    outputString += "<tr><td align=""center"" class=""text"">" & dtTable.Rows(i)("MaterialCostGroupID").ToString & "</td>"
                    ...
                    outputString += "<td align=""center"" class=""text""><a href=""Material_Cost_Group.aspx?Action=Edit&MaterialCostGroupID=" & dtTable.Rows(i)("MaterialCostGroupID").ToString & """>" & defaultTextTable.Rows(0)("TextParamValue") & "</a></td>"
...
Sub DoAddUpdate(Source As Object, E As EventArgs)
	...
	If FoundError = False Then
		...
		Application.Lock()
		Result = CostInfo.AddUpdateCostGroup(CostGroupName.Text,MaterialCostGroupID.Value,StartString,EndString,Session("StaffID"), objCnn)
		Application.UnLock()
