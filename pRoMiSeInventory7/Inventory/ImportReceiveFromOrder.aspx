<%@ page language="VB" autoeventwireup="false" inherits="Inventory_ImportReceiveFromOrder, App_Web_importreceivefromorder.aspx.9758fd70" enableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ImportReceiveFromOrder</title>
    <style>
        /* -- General styles ------------------------------ */
        body
        {
    ...
    <div style="width: 800px; margin: 30px;">
        <fieldset>
            ...
            <table class="adminlist" cellspacing="1">
                <tr>
                    <td>
                        <asp:FileUpload ID="FileUpload1" runat="server" style="width:80%;"/>
                        <asp:Button ID="BtnUpload" runat="server" Text="Import File" Height="25px" />
                        
                    </td>
                    <td align="center"><asp:CheckBox ID="ckb_validate_vendor" runat="server" Checked="true" /></td>
                    <td><label for="ckb_validate_vendor">Validate Vendor</label></td>
                </tr>
            </table>
        </fieldset>
