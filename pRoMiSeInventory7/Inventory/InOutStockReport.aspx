<%@ page language="VB" autoeventwireup="false" inherits="Inventory_InOutStockReport, App_Web_inoutstockreport.aspx.9758fd70" maintainscrollpositiononpostback="true" theme="Classic" enableEventValidation="false" %>
                ...
                <div class="jpane-slider">
                    <table class="paramlist admintable" cellspacing="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlMaterialDept" runat="server" Width="220px">
                                </asp:DropDownList>
                            </td>
                            <td class="paramlist_key">
                                &nbsp;
