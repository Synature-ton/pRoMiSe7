<%@ page language="VB" autoeventwireup="false" inherits="Inventory_SearchTranferOrRequestDocument, App_Web_searchtranferorrequestdocument.aspx.9758fd70" enableEventValidation="false" %>
    ...
    <div id="content">
        ...
        <div style="padding: 5px; text-align: center;">
            ...
            <button id="DoCloseWindow" runat="server" type="button">
               ปิดหน้าต่างเพื่อรีโหลดรอบเอกสารขอสินค้า
            </button>
