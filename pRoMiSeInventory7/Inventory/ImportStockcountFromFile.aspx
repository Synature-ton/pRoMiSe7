<%@ page language="VB" autoeventwireup="false" inherits="Inventory_ImportStockCountFromFile, App_Web_importstockcountfromfile.aspx.9758fd70" enableEventValidation="false" %>
                ...
                <div style="float: left; font-size: 14px;">
                    ...
                    <div style="float: left;">
                        <div style="margin: 2px 0 0 2px;">
                           <b><asp:Label ID="lblHeader" runat="server" Text="Import Stock Count Material CSV File."></asp:Label></b></div>                      
                    </div>
                </div>
            ...
            <div id="content-pane" class="pane-sliders">
                <div class="panel">
                    <h3 id="detail-page" class="title jpane-toggler">
                        <asp:Label ID="lblImportStockCount" runat="server">Import Stock Count Material</asp:Label>
                    </h3>
                        ...
                        <table class="paramlist admintable" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Button ID="btnImport" runat="server" Text="Import File" Width="120px" Height="35px" />                                                       
