<%@ page language="VB" autoeventwireup="false" inherits="Inventory_SearchVendors, App_Web_searchvendors.aspx.9758fd70" enableEventValidation="false" %>
            ...
            <div id="content-pane" class="pane-sliders">
                <div class="panel">
                    <h3 id="detail-page" class="title jpane-toggler">
                        <asp:Label ID="lb1" runat="server">Search Vendors</asp:Label>
                    </h3>
                    <div class="jpane-slider">
                        <table class="paramlist admintable" cellspacing="1" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtVendorCode" runat="server" Width="250px" AutoPostBack="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="paramlist_key">
                                    <asp:Label ID="lb4" runat="server" Text="Label">VendorGroup</asp:Label>
                                </td>
                                <td>
