                ...
                <div class="jpane-slider">
                    <table class="paramlist admintable" cellspacing="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="paramlist_key">
                                <asp:Label ID="lblVendorGroup" runat="server">VendorGroup</asp:Label>
                                <asp:Label ID="lblAddReduce" runat="server" Style="display: none;">Document Type</asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlVendorGroup" runat="server" AutoPostBack="True" Width="250px">
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlAddReduce" runat="server" Width="250px" AutoPostBack="True" Style="display: none;">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="paramlist_key">
                                ...
                                <asp:Label ID="lblAddReduceDocument" runat="server" Style="display: none;">Document</asp:Label>
                            </td>
                            <td>
