                        ...
                        gridComplete: function() {
                            ...
                            if(data != null){
                                ...
                                if(data.weeklyCount == 0){
                                    $("#alert_msg").text('ไม่สามารถนับสต๊อกได้ วันนี้ไม่ใช่วันนับสต๊อกรายสัปดาห์');
                                    alertDialog();
                                }
...
//                            $("#alert_msg").html('<%=lbl_3_30.Text %>');
    ...
    <asp:Label ID="lbl_3_34" runat="server" Text="ไม่พบเอกสารนับสต๊อกรายสัปดาห์ที่สร้างไว้ กรุณาตรวจสอบข้อมูลอีกครั้ง" Style="display:none;"></asp:Label>
