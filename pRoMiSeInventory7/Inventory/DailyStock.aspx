            ...
            <div id="selFormDialog" style="display:none">
                <div style="margin:8px">
                    <button id="btnForm1" type="button" style="margin-right: 2px; width:100%;" class="btn">
                        <asp:Label ID="lbl_2_17" Text="ฟอร์ม1" runat="server" class="btn"></asp:Label>
                    </button>
                </div>
                <div style="margin:8px">
                    <button id="btnForm2" type="button" style="margin-right: 2px; width:100%" class="btn">
                        <asp:Label ID="lbl_2_18" Text="ฟอร์ม2" runat="server" class="btn"></asp:Label>
                    </button>
                </div>
            </div>
            <script type="text/javascript">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                ...
                                &nbsp;
                                <button id="btnDisplayMaterial" type="button" style="margin-right: 2px; width: 110px;" class="btn">
                        ...
                        gridComplete: function() {
                            ...
                            if (data != null) {
                                ...
                                if (data.approve == 99 || data.approve == 1) {
                                    ...
                                    "#txtCountUnitName", "#btnCountMat", "#btnApprove", "#btnSaveForm", "#btnCancelCountStock", "#btnAutoTransferStock");
                                    disableControl(control);
                                } else if (data.approve == "98") {
                                    $("#alert_msg").text('<%=lbl_3_35.Text %>');
                                    alertDialog();
                                    var control = new Array();
                                    control.push("#txtMatCode", "#txtMatName", "#txtMatRemainAmount", "#txtCountAmount",
                                    "#txtCountUnitName", "#btnCountMat", "#btnApprove", "#btnSaveForm", "#btnCancelCountStock", "#btnAutoTransferStock");
...
//                                    }
    ...
    <asp:Label ID="lbl_3_35" runat="server" Text="ไม่พบเอกสารนับสต๊อกรายวันที่สร้างไว้ กรุณตรวจสอบข้อมูลอีกครั้ง" Style="display:none;"></asp:Label>
