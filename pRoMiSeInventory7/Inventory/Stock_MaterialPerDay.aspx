<%@ page language="VB" autoeventwireup="false" inherits="Inventory_Stock, App_Web_stock_materialperday.aspx.9758fd70" maintainscrollpositiononpostback="true" theme="Classic" enableEventValidation="false" %>

<%@ Register TagPrefix="uc1" TagName="MenuBar" Src="~/UserControl/Menu.ascx" %>
<html>
<head runat="server">
    <title>Stock Card Per Material.</title>
...
<body>
    ...
    <div id="content">
        <div style="display: none;">
            ...
            <asp:Label ID="lblSummary" runat="server">Summary :</asp:Label>
            <asp:Label ID="lblDocDate" runat="server">Document Date</asp:Label>
            ...
            <asp:Label ID="lblUseAmount" runat="server">Amount</asp:Label>
            <asp:Label ID="lblProductUseMaterial" runat="server">Product Use This Material.</asp:Label>
        </div>
                    ...
                    <table class="paramlist admintable" cellspacing="1" width="100%">
                        <tr>
                            <td class="paramlist_key" style="width: 141px">
                             ...
                             <td rowspan="4" valign="top" nowrap="nowrap" width="195px">
                                <asp:Panel ID="pnlInventoryGroup" runat="server" Height="120px" ScrollBars="Auto" BorderColor="#999999"
                                    ...
                                    <div id="chkInvGroup" runat="server">
                                        <asp:CheckBoxList ID="chkbInventoryGroup" runat="server" AutoPostBack="true" Height="16px" Width="170px">
                                        </asp:CheckBoxList>
                                    </div>
                                </asp:Panel>
                            </td>                        
                            <td class="paramlist_key" style="width: 100px">
                                <asp:Label ID="lb2" runat="server">Inventory</asp:Label>
                            </td>
                            <td rowspan="4" valign="top" nowrap="nowrap" width="210px">
                                <asp:Panel ID="pnlInventory" runat="server" Height="120px" ScrollBars="Auto" BorderColor="#999999"
                                  BorderStyle="Solid" BorderWidth="1px">
                                   ...
                                   <asp:CheckBoxList ID="chkbInventory" runat="server" Height="16px" Width="190px">
                                    </asp:CheckBoxList>
                                </asp:Panel>
                            </td>
                            ...
                            <td class="paramlist_key" style="width: 112px">
                                <asp:Label ID="lb7" runat="server" Height="23px" Width="35px">Date</asp:Label>
                            </td>
                            <td nowrap="nowrap">
                        ...
                        <tr>
                            ...
                            <td class="paramlist_key" style="width: 110px">
                                &nbsp;
                            </td>
                            <td class="paramlist_key">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlMaterialDept" runat="server" AutoPostBack="true" Width="100%">
                                </asp:DropDownList>
                            </td>
                            <td class="paramlist_key" style="width: 112px">
                        ...
                        <tr>
                            ...
                            <td class="paramlist_key">
                                  <asp:Label ID="lblMaterial" runat="server">Material</asp:Label>
                                   &nbsp;</td>
                            <td>
                            ...
                            <td>
                                <button id="btnSearch" type="button" runat="server" ValidationGroup="v">Search</button>
                            </td>
                        </tr>
                        <tr>
                            <td class="paramlist_key">
                            ...
                            <td class="paramlist_key">
                                <asp:Label ID="lblSearchBy" runat="server">Or Search By :</asp:Label>
        ...
        <tr><td align="right"><asp:Label ID="lblCreateReportDate" Text="" runat="server" /></td></tr>
        </table>
